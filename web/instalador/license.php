...
<head>
    ...
    <link rel="stylesheet" href="css/firsttime" type="text/css">
    <script src="js/check.js"></script>
</head>
<body>
    <div id="tudo">
        <h5>Por favor, leia os termos da licença a seguir.</h5>
        <h5>Você deve concordar com os termos para utilizar o cacic!</h5>
        <div id="license">
            ...
            qualquer pessoa, ou então que nem necessite ser licenciada.</p>
            ...
            <p>1. Você pode copiar e distribuir cópias fiéis do código-fonte do
            ...
            <p>Você pode cobrar pelo ato físico de transferir uma cópia e pode,
            opcionalmente, oferecer garantia em troca de pagamento.</p>

            <p>2. Você pode modificar sua cópia ou cópias do Programa, ou qualquer
            ...
            <dl>
                <dd><p>a) Você tem que fazer com que os arquivos modificados levem avisos
                proeminentes afirmando que você alterou os arquivos, incluindo a data
                de qualquer alteração.</p></dd>

                <dd><p>b) Você tem que fazer com que quaisquer trabalhos que você
                ...
                terceiros, sob os termos desta Licença.</p></dd>

                <dd><p>c) Se qualquer programa modificado normalmente lê comandos
                ...
                imprimir um anúncio.)</p></dd>
            </dl>
            <p>Estas exigências aplicam-se ao trabalho modificado como um todo. Se
            ...
            <p>Desta forma, esta seção não tem a intenção de reclamar direitos os
            ...
            <p>Adicionalmente, a mera adição ao Programa de outro trabalho não
            ...
            parte do escopo desta Licença.</p>

            <p>3. Você pode copiar e distribuir o Programa (ou trabalho baseado
            ...
            faça um dos seguintes:</p>
            <dl>
                <dd><p>a) O acompanhe com o código-fonte completo e em forma acessível
                ...
                <dd><p>b) O acompanhe com uma oferta escrita, válida por pelo menos três
                ...
                normalmente utilizado para o intercâmbio de software; ou,</p></dd>

                <dd><p>c) O acompanhe com a informação que você recebeu em relação à
                ...
                executável, com oferta de acordo com a Subseção b acima.)</p></dd>
            </dl>
            <p>O código-fonte de um trabalho corresponde à forma de trabalho
            ...
            <p>Se a distribuição do executável ou código-objeto é feita através da
            ...
            a copiar o código-fonte com o código-objeto.</p>

            <p>4. Você não pode copiar, modificar, sub-licenciar ou distribuir o
            ...
            <p>5. Você não é obrigado a aceitar esta Licença já que não a
            ...
            <p>Se qualquer parte desta seção for considerada inválida ou não
            aplicável em qualquer circunstância particular, o restante da seção se
            aplica, e a seção como um todo se aplica em outras circunstâncias.</p>

            <p>O propósito desta seção não é o de induzi-lo a infringir quaisquer
            ...
            incorpora a limitação como se a mesma constasse escrita nesta Licença.</p>

            <p>9. A Free Software Foundation pode publicar versões revisadas e/ou
            ...
            <p>10. Se você pretende incorporar partes do Programa em outros
            ...
            REPAROS E CORREÇÕES.</p>

            <p>12. EM NENHUMA OCASIÃO, A MENOS QUE EXIGIDO PELAS LEIS APLICÁVEIS OU
            ...
            <dl>
                ...
                Copyright (C) [ano]  [nome do autor]</p></dd>
               
                <dd><p>Este programa é software livre; você pode redistribuí-lo e/ou
                modificá-lo sob os termos da Licença Pública Geral GNU, conforme
                publicada pela Free Software Foundation; tanto a versão 2 da
                Licença como (a seu critério) qualquer versão mais nova.</p></dd>

                <dd><p>Este programa é distribuído na expectativa de ser útil, mas SEM
                QUALQUER GARANTIA; sem mesmo a garantia implícita de
                COMERCIALIZAÇÃO ou de ADEQUAÇÃO A QUALQUER PROPÓSITO EM
                PARTICULAR. Consulte a Licença Pública Geral GNU para obter mais
                detalhes.</p></dd>

                <dd><p>Você deve ter recebido uma cópia da Licença Pública Geral GNU
        ...
        <form name="terms" action="form_dados.php" method="POST">

        <label><input type="checkbox" name="lido" onclick="validate()">Li e concordo com os termos acima</label>
        <div id="go"><input type="submit" value="Continuar" disabled="true"></div>
        </form> 
    </div>
</body>
</html>