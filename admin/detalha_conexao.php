...
<table width="90%" border="0" align="center">
  ...
  <tr>
    <td bgcolor="<? echo $strCorSrv; ?>" colspan="2" class="cabecalho_secao" align="left">Estação Local (Visitada)</td>  
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor="<? echo $strCorCli; ?>" colspan="2" class="cabecalho_secao" align="left">Estação Remota (Visitante)</td>    
    </tr>
...
if(mysql_num_rows($result)==0) 
	...
	$msg = '<div align="center">
			<font color="red" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				Sem Detalhes para Exibicao</font><br><br></div>';			
	}
else 
	{
	$Cor = 0;
