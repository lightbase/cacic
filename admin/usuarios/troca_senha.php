...
if ($_POST['GravaAlteracoes']) 
	...
	{
	$intIdUsuario = ( ( $_SESSION[ 'cs_nivel_administracao' ] == 1 && array_key_exists('id_usuario', $_GET)  )
				? (int) $_GET[ 'id_usuario' ]
				: $_SESSION['id_usuario']
			);
...
<form action="troca_senha.php"  method="post" ENCTYPE="multipart/form-data" name="forma">
	<input name="frm_id_usuario" type="hidden" id="frm_id_usuario" value="<? echo $intIdUsuario;?>">
...
<? if ( $_SESSION['id_usuario'] == $intIdUsuario ) : ?> 
          <tr> 
