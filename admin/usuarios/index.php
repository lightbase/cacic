...
<p><br></p><table border="0" align="center" cellpadding="0" cellspacing="1">
  ...
  <tr> 
    <td> <table border="0" cellpadding="2" cellspacing="0" bordercolor="#333333" align="center">
  	...
  	<tr> 
    <td height="1" bgcolor="#333333" colspan="<? echo ($intColunasExtras + ($intColunasExtras*3) + $intColunasFim);?>"></td>
  	</tr>
...
if(mysql_num_rows($result)==0) 
	...
	while($row = mysql_fetch_array($result)) 
	    ...
	    <? if ($_SESSION['cs_nivel_administracao'] == 1) :?>
	    <td nowrap>
		<a href="troca_senha.php?id_usuario=<? echo $row['id_usuario'];?>"><img src="../../imgs/trocar_senha.png" alt="Trocar Senha do Usuário" title="Trocar Senha do Usuário" border="0"></a>
	    </td>
	    <? endif;?>
            <? 
		$Cor=!$Cor;
...
?>
  <tr> 
    <td colspan="<? echo ($intColunasExtras + ($intColunasExtras*3) + $intColunasFim);?>" height="1" bgcolor="#333333"></td>
  </tr>
