 ...
 class Configuracao_Padrao extends Configuracao {
    ...
    function Configuracao_Padrao() {
    	...
    	$this->clearVar('CommonSetup_head', 'CACIC_TITLE');
     	...
     	$this->addVar('StandardSetup_form', 'NU_REL_MAXLINHAS_TITLE', $this->oTranslator->_('Quantidade maxima de linhas em relatorios') );
     	$this->addVar('StandardSetup_form', 'NU_REL_MAXLINHAS_HELP', $this->oTranslator->_('Quantidade maxima de linhas em relatorios') );
