...
//						  '$frm_te_dir_pad_wnt', 
		...
		$query = "INSERT INTO perfis_aplicativos_monitorados
				  ...
				  VALUES ('$frm_nm_aplicativo',
				  		  ...
				  		  '$frm_cs_ide_licenca',
				  		  '$frm_te_ide_licenca',
						  '$frm_te_arq_ver_eng_w9x',
				  		  '$frm_te_arq_ver_pat_w9x',				  
				  		  '$frm_te_arq_ver_eng_wnt',
				  		  '$frm_te_arq_ver_pat_wnt',	  				  						
				  		  '$frm_id_so',	  				  												  
				  		  '$frm_te_descritivo',	  				  												  						  
						  now(),
...
<form method="post" ENCTYPE="multipart/form-data" name="forma" onSubmit="return valida_form()">
  ...
  <table width="90%" border="0" align="center">
    <tr> 
      <td nowrap class="label">Nome do sistema:<br> <input name="frm_nm_aplicativo" type="text" id="frm_nm_aplicativo2" size="80" maxlength="100" class="normal" onFocus="SetaClassDigitacao(this);" onBlur="SetaClassNormal(this);" ></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td nowrap class="label">Identificador de Instala&ccedil;&atilde;o:<br> <select name="frm_cs_car_inst_w9x" id="select7" onChange="SetaDescGrupo(this.options[selectedIndex].id,'Ajuda2')" class="normal" onFocus="SetaClassDigitacao(this);" onBlur="SetaClassNormal(this);" >
          ...
          em Registry</option>
        </select> <br> <input name="frm_te_car_inst_w9x" type="text" id="frm_te_car_inst_w9x" size="80" maxlength="100" class="normal" onFocus="SetaClassDigitacao(this);" onBlur="SetaClassNormal(this);" > 
    ...
    <tr> 
      <td nowrap class="label">Identificador de Vers&atilde;o/Configura&ccedil;&atilde;o:<br> 
        ...
        </select> <br> <input name="frm_te_car_ver_w9x" type="text" id="frm_te_car_ver_w9x" size="80" maxlength="100"> 
    ...
    <tr> 
      <td nowrap class="label">Identificador de Instala&ccedil;&atilde;o:<br> <select name="frm_cs_car_inst_wnt" id="select9" onChange="SetaDescGrupo(this.options[selectedIndex].id,'Ajuda4')" class="normal" onFocus="SetaClassDigitacao(this);" onBlur="SetaClassNormal(this);" >
          ...
          <option value="3" id="Ex.:  HKEY_LOCAL_MACHINE\Software\Dataprev\Cacic2\id_versao">Caminho\Chave\Valor 
          em Registry</option>
        </select> <br> <input name="frm_te_car_inst_wnt" type="text" id="frm_te_car_inst_wnt" size="80" maxlength="100" class="normal" onFocus="SetaClassDigitacao(this);" onBlur="SetaClassNormal(this);" > 
...
<?
  ...
  <table width="90%" border="0" align="center" cellspacing="1">
    ...
    <tr> 
      <td nowrap><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
          ...
          <input name="frm_te_arq_ver_pat_w9x" type="text" id="frm_te_arq_ver_pat_w9x" size="101" maxlength="100">
  		<br>
  ...
  <table width="90%" border="0" align="center" cellspacing="1">
    ...
    <tr> 
      <td nowrap><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
          <input name="frm_te_arq_ver_pat_wnt" type="text" id="frm_te_arq_ver_pat_wnt" size="101" maxlength="100">
  		<br>
