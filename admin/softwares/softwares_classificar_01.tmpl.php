			...
			<tr  height="70">
             ...
             <softwareClassificacao:tmpl name="SoftwaresType_list">
			  <td width="5%" class="header">
			   <object data="softwares_classificar_tipo_svgimage.php?texto={SOFTWARE_TYPE_NAME}" type="image/svg+xml"></object>
			  </td>
			 </softwareClassificacao:tmpl>
			</tr>
		  	...
		  	<tr>
		  		<td colspan="{COLSPAN}" class="botoes">
				      ...
				      <span  class='botoes{BTN_SALVAR_DENY}'>
				        <input type='button' title="{BTN_SALVAR}" name="{BTN_SALVAR}" onClick="setDocVar( 'btn_salvar', 1 ); setDocVar( 'page', {PAGE_NEXT} ); sendForm(this.form);" value="{BTN_SALVAR}" {BTN_SALVAR_DENY} />
				      </span>
