...
<table border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#999999">
  ...
  <tr bgcolor="#E1E1E1"> 
    <td nowrap bgcolor="#FFFFFF"><div align="center"><font color="#333333" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>CACIC - Relatorio de Instala&ccedil;&otilde;es de Software Particular</strong></font></div></td>
  </tr>
  <tr> 
...
conecta_bd_cacic();
	...
	$query = "SELECT s.nm_software, COUNT(se.id_software) 
		...
		WHERE (s.id_software = " . $v_id_software . ") AND 
		      (se.id_software = s.id_software) AND 
...
<td align="right" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Instala&ccedil;&otilde;es: '.$row[1].'</strong></font></td></tr>
	...
	$query =  "SELECT nm_computador, nr_patrimonio, dt_autorizacao, nr_processo 
