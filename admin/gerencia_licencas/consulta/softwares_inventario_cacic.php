...
while ($row = mysql_fetch_row($result)) { //Table body
    ...
    echo '<td nowrap align="left"><font size="1" face="Verdana, Arial"><a href="../../../relatorios/software/rel_softwares_orgao.php?id_software_inventariado=' . $row[0] . '&nm_software_inventariado=' . $row[1] . '&nm_maquina="">' . $row[1] . '</a></td>';
