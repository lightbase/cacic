...
session_start();
/*
 * verifica se houve login e tambÃ©m as permissÃµes de usuÃ¡rio
 */
if(!isset($_SESSION['id_usuario'])) 
    die('Acesso negado!');
    else { // Inserir regras para verificar permissÃµes do usuÃ¡rio!
}
...
<table border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#999999">
  ...
  <tr bgcolor="#E1E1E1"> 
    <td nowrap bgcolor="#FFFFFF"><div align="center"><font color="#333333" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>CACIC - Relat&oacute;rio de Aquisi&ccedil;&otilde;es de Software</strong></font></div></td>
  </tr>
  <tr> 
...
conecta_bd_cacic();
   if ($v_id_software != '') {
   	$query =  "SELECT id_aquisicao, dt_aquisicao, nr_processo  
		FROM aquisicoes  
		WHERE id_aquisicao IN (SELECT DISTINCT id_aquisicao  
					FROM aquisicoes_item 
					WHERE id_software = " . $v_id_software . ") ORDER BY id_aquisicao"; 
   } else {
	$query = "SELECT id_aquisicao, dt_aquisicao, nr_processo 
		FROM aquisicoes  
