 ...
 */
 class Softwares_Classificar extends Cacic_Common {
    ...
    function fillForm($_btn_salvar) {
		...
		# Eduardo: 11/04/2013
		# Filtra resultados exibindo somente os softwares que estão classificados como licenciados
		$where = $where." and id_tipo_software = 5";

		if (isset($software_nao_classificado) and ($software_nao_classificado==0)) {

			# Eduardo: 11/04/2013
			# Filtra resultados exibindo somente os softwares que estão classificados como licenciados
			$where = " where id_tipo_software = 5";
