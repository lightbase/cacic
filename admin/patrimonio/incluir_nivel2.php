...
if(mysql_num_rows($result_sel1))
  ...
  echo '<input name="gravainformacaoUON2" type="submit" value="  Gravar Informa&ccedil;&otilde;es  "'. ($_SESSION['cs_nivel_administracao']<>1?'disabled':'') .' onClick="return '.$v_frase.'";>';
  ?>
