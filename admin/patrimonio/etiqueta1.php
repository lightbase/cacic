...
<form name="form1" method="post" action="etiqueta_generica.php">
  <table width="600" border="0" align="center">
    ...
    <tr> 
      ...
      <td class="descricao">Ex: Selecione ger&ecirc;ncia onde est&aacute; localizado este equipamento.</td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td colspan="3" nowrap> <div align="center"> 
          <input name="gravar" type="submit" id="gravar" value="   Gravar   " onClick="return Confirma('Confirma Configuração de Etiqueta 1?');" <? echo ($_SESSION['cs_nivel_administracao']<>1?'disabled':'')?>>
        </div></td>
    </tr>
  </table>
</form>
