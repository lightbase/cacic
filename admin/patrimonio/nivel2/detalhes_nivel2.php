...
if ($_POST['exclui_uon2']) 
   ...
   $result_UON1a  = mysql_query($queryUON1a);			
	...
	if(mysql_num_rows($result_UON1a))
	  ...
	  ?>
	  <input name="gravainformacaoUON2" type="submit" value="<?=$oTranslator->_('Gravar Informacoes');?>" <? echo ($_SESSION['cs_nivel_administracao']<>1 && $_SESSION['cs_nivel_administracao']<>3?'disabled':'');?>  onClick="return <? echo $v_frase;?>">
	&nbsp; &nbsp; 		  
