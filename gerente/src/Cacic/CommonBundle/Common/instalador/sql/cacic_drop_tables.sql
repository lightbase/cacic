...
DROP TABLE if exists 	componentes_estacoes; 
DROP TABLE if exists 	componentes_estacoes_historico; 
...
DROP TABLE if exists 	insucessos_instalacao; 
...
DROP TABLE if exists 	servidores_autenticacao; 
...
DROP TABLE if exists 	srcacic_chats; 
DROP TABLE if exists 	srcacic_conexoes; 
DROP TABLE if exists 	srcacic_sessoes; 
DROP TABLE if exists 	srcacic_transfs; 
