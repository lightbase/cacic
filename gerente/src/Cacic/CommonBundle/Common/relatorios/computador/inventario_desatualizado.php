  ...
  <tr> 
    <td> <table border="0" cellpadding="5" cellspacing="0" bordercolor="#333333" align="center">
        <tr bgcolor="#E1E1E1"> 
          ...
          <td nowrap class="cabecalho_tabela" align="center"></td>
          <td nowrap class="cabecalho_tabela" align="center">&nbsp;&nbsp;</td>
          <td nowrap class="cabecalho_tabela" align="center" bgcolor="#E1E1E1"><div align="center"><?php echo $oTranslator->_('Nome da Maquina');?></div></td>
		  ...
		  <td nowrap class="cabecalho_tabela"><div align="center"><?php echo $oTranslator->_('Endereco IP');?></div></td>
	  	  <td nowrap class="cabecalho_tabela" >&nbsp;&nbsp;</td>
	  	  <td nowrap class="cabecalho_tabela"><div align="center"><?php echo $oTranslator->_('Ultima Coleta');?></div></td>
	  	  <td nowrap class="cabecalho_tabela" >&nbsp;&nbsp;</td>
	  	  <td nowrap class="cabecalho_tabela"><div align="center"><?php echo $oTranslator->_('Versao do agente principal');?></div></td>
	  	  <td nowrap class="cabecalho_tabela" >&nbsp;&nbsp;</td>
	  	  <td nowrap class="cabecalho_tabela" ><div align="center"><?php echo $oTranslator->_('CPU');?></div></td>
	  	  <td nowrap class="cabecalho_tabela" >&nbsp;&nbsp;</td>
        </tr>
        <?php  
	$Cor = 0;
