...
<table border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#999999">
  ...
  <tr bgcolor="#E1E1E1"> 
    <td nowrap bgcolor="#FFFFFF"><font color="#333333" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>CACIC 
      - Relat&oacute;rio de M&aacute;quinas Matrix</strong></font></td>
  </tr>
  <tr> 
...
?>
<?php
	 $query = "SELECT a.te_nome_computador as nm_maquina, a.te_cpu_desc, 
			  a.te_placa_mae_desc, a.qt_mem_ram, a.te_cpu_freq, 
			  a.te_node_address, a.id_so,a.id_computador  
		FROM computadores a 
		WHERE (a.te_cpu_desc LIKE '%duron%') OR 
		      (a.te_cpu_desc = 'Pentium III') 
  ...
  <tr> 
    <td> <table border="0" cellpadding="6" cellspacing="0" bordercolor="#333333" align="center">
	  ...
	  <td wrap ><div align="center"><strong><font color="#333333" size="2" face="Verdana, Arial, Helvetica, sans-serif">Placa Mãe</font></strong></div></td>
          <td nowrap >&nbsp;&nbsp;</td>
	  <td nowrap ><div align="center"><strong><font color="#333333" size="2" face="Verdana, Arial, Helvetica, sans-serif">Qtde. Memória</font></strong></div></td>
          <td nowrap >&nbsp;&nbsp;</td>
	...
	while($row = mysql_fetch_array($result)) {
	 ...
	 ?>
        <tr <?php if ($Cor) { echo 'bgcolor="#E1E1E1"'; } ?>> 
          ...
          <td nowrap>&nbsp;&nbsp;</td>
	  <td align="center" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $row['te_cpu_desc']; ?></font></td>
          <td nowrap>&nbsp;&nbsp;</td>
	  <td align="center" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $row['te_placa_mae_desc']; ?></font></td>
          <td nowrap>&nbsp;&nbsp;</td>
	  <td align="center" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $row['qt_mem_ram']; ?></font></td>
          <td nowrap>&nbsp;&nbsp;</td>
	  <td align="center" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $row['te_cpu_freq']; ?></font></td>
	  <td nowrap>&nbsp;&nbsp;</td>
          <?php 
	$Cor=!$Cor;
	$NumRegistro++;
