...
<table width="85%" border="0" align="center">
  <tr> 
    <td class="cabecalho">Relat&oacute;rio 
      de Vari&aacute;veis de Ambiente</td>
  </tr>
  <tr> 
    <td class="descricao">Este relat&oacute;rio 
      exibe as vari&aacute;veis de ambiente identificadas nos computadores das 
      redes selecionadas. &Eacute; poss&iacute;vel determinar quais vari&aacute;veis 
      ter&atilde;o seus valores exibidos no relat&oacute;rio, os sistemas operacionais 
      e a abrang&ecirc;ncia das redes.</td>
  </tr>
  <tr> 
    <td>
				</td>
...
<form action="../variaveis_ambiente/variaveis.php" target="_blank" method="post" ENCTYPE="multipart/form-data" name="forma"   onsubmit="return valida_form()">
  <table width="85%" border="0" align="center">
    <tr> 
	<?php
	/*
      ...
      <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1">
          <tr> 
            <td class="label">Selecione 
              as vari&aacute;veis que deseja exibir:</td>
          </tr>
          <tr> 
            <td height="1" bgcolor="#333333"></td>
          </tr>
          <tr> 
            <td height="1"><table border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  ...
                  <td width="40">&nbsp;</td>
                  <td nowrap>&nbsp;&nbsp;</td>
                  <td nowrap class="cabecalho_tabela">Selecionadas:</td>
                  <td nowrap>&nbsp;&nbsp;</td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
                  <td> <div align="left"> 
                      <select multiple name="list5[]" size="10" class="normal" onFocus="SetaClassDigitacao(this);" onBlur="SetaClassNormal(this);" >
                        <?php 	$query = "SELECT id_variavel_ambiente, nm_variavel_ambiente
						...
						if ($_SESSION['te_locais_secundarios']<>'')
							...
							$query = "SELECT 	distinct va.id_variavel_ambiente, 
									  ...
									  WHERE     va.id_variavel_ambiente = vae.id_variavel_ambiente AND 
									            vae.id_computador = c.id_computador AND
