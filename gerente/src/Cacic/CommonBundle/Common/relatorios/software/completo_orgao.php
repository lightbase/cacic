...
<body bgcolor="#FFFFFF" background="/cacic3/imgs/linha_v.gif" onLoad="SetaCampo('sigla_orgao')">
...
<?php if ($_POST['consultar']) {
	...
	WHERE (s.id_computador = c.id_computador) 
...
<table border="0" width="85%" align="center" cellpadding="0" cellspacing="1">
  ...
  <tr> 
	...
	<tr bgcolor="#AAAAAA">
	  <td align="center" colspan=7><b>&Oacute;rg&atilde;o: <?php echo $_SESSION['sigla_orgao_consulta'];?></b></td>
	</tr>
        <tr bgcolor="#E1E1E1">
	...
	while($row = mysql_fetch_array($result)) {
	 ...
	 ?>
        <tr <?php if ($Cor) { echo 'bgcolor="#E1E1E1"'; } ?>> 
          ...
          <td nowrap>&nbsp;</td>
          <td class="opcao_tabela"><a href="rel_completo_orgao.php?id_software_inventariado=<?php echo $row['id_soft'];?>&nm_software_inventariado=<?php echo $row['nm_soft'];?>&nm_maquina=<?php echo $_SESSION['sigla_orgao_consulta'];?>" target="_blank"><?php echo $row['nm_soft']; ?></a></td>
          <td nowrap>&nbsp;</td>
