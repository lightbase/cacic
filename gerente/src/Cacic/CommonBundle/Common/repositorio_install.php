  ...
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    <tr> 
      <td height="17">&nbsp;</td>
		...
		*/ ?>
	    <tr> 
	    <td bgcolor="#CCCCCC" class="label"><br>
	      <a href="tribo/docs/Cacic-Manual-Instalacao-Utilizacao-v2601.pdf" target="_self">Manual para Instalação e Utilização - versão 2.6.0-Beta-1<span class="style6">&nbsp;(2.4MB)</span></a></td>
    	</tr>    
    <tr> 
      <td height="17">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
          <tr> 
            <td class="label"><a href="<? echo $path_relativo_repositorio_instalacao;?>/pyCACIC_<? echo $v_array_versoes_agentes_LINUX['pyCACIC'];?>_Debian.deb">pyCACIC (DEBIAN) - Instalador em plataforma GNU/Linux - Distros Debian <span class="style2"><span class="style6">(versão <? echo $v_array_versoes_agentes_LINUX['pyCACIC'];?>  ~  800K)</span></span></a> </td>
          </tr>
    <tr> 
      <td>&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
          <tr> 
            <td class="label"><a href="<? echo $path_relativo_repositorio_instalacao;?>/pyCACIC_<? echo $v_array_versoes_agentes_LINUX['pyCACIC'];?>_RedHat.rpm">pyCACIC (RedHat) - Instalador plataforma GNU/Linux - Distros RedHat <span class="style2"><span class="style6">(versão <? echo $v_array_versoes_agentes_LINUX['pyCACIC'];?>  ~  800K)</span></span></a> </td>
          </tr>
    <tr> 
      <td>&nbsp;</td>
    </tr>
