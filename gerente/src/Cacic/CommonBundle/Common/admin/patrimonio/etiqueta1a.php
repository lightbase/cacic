  ...
  <table width="600" border="0" align="center">
    <tr> 
      <td nowrap class="label">
        ...
        &quot;<?php echo $oTranslator->_('Etiqueta 1a');?>&quot;:
      </td>
      ...
      <td class="descricao">
        ...
        &quot;<?php echo $oTranslator->_('Linha de negocio');?>&quot;
      </td>
    </tr>
    <tr> 
      <td nowrap class="label">
      ...
      <td class="descricao">
        <?php echo $oTranslator->_('Exemplo',T_SIGLA);?>
        &quot;<?php echo $oTranslator->_('Linhas de negocios');?>&quot;
      </td>
    </tr>
    ...
    <tr> 
      ...
      <td class="descricao">
        <?php echo $oTranslator->_('Exemplo',T_SIGLA);?>
        &quot;<?php echo $oTranslator->_('Selecione a Linha de negocio de localizacao deste equipamento');?>&quot;
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td colspan="3" nowrap> <div align="center"> 
          ...
          <input name="gravar" type="submit" id="gravar" value="<?php echo $oTranslator->_('Gravar Alteracoes');?>" onClick="return Confirma('<?php echo $oTranslator->_('Confirma Configuracao de Etiqueta 1a?');?>');" <?php echo ($_SESSION['cs_nivel_administracao']<>1 && $_SESSION['cs_nivel_administracao']<>3?'disabled':'')?>>
        </div></td>
    </tr>
  </table>
</form>
