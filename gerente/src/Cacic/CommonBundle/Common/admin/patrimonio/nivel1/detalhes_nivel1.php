...
<table width="85%" border="0" align="center">
  <tr> 
    <td class="cabecalho"><?php echo $oTranslator->_('Detalhes de');?> <?php echo $_SESSION['etiqueta1'];?> (<?php echo $oTranslator->_('Unidade Organizacional Nivel 1');?>)</td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
  </tr>
  ...
  <tr> 
    <td valign="top"> <form method="post" ENCTYPE="multipart/form-data" name="form" onSubmit="return valida_form()">
		...
		if ($_SESSION['cs_nivel_administracao'] == 1)
		  ...
		  ?>
&nbsp; &nbsp; 		  
          <input name="exclui_uon1" type="submit" onClick="return ConfirmaExclusao()" id="exclui_uon1" value="<?php echo $oTranslator->_('Excluir');?> <?php echo $_SESSION['etiqueta1'];?>" >		  
          <?php
		  }
		  ?>
        </p>		
