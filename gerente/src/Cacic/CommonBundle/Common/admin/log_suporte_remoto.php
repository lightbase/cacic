...
<title><?php echo $oTranslator->_('Log de Suporte Remoto');?></title>
...
<table width="85%" border="0" align="center">
  <tr> 
    <td class="cabecalho"><div align="left"><?php echo $oTranslator->_('Log de Suporte Remoto');?></div></td>
  </tr>
  <tr> 
      <td class="descricao"><?php echo $oTranslator->_('kciq_msg Log de suporte remoto help');?></td>
  </tr>
</table>
	<p><br></p>
  ...
  <table width="85%" border="0" cellpadding="0" cellspacing="1" align="center">
    <tr> 
      <td class="label" colspan="3"><?php echo $oTranslator->_('Selecione o periodo no qual devera ser realizada a consulta');?>:</td>
    </tr>
    <tr> 
	...
	<input name="where_locais" type="hidden" value="<?php echo $where_locais;?>"> 	  
	...
	if ($_REQUEST['date_input1'])
		...
		$itens_locais = '';
                ...
                if (count($_POST['list12'])==0)
                	$msg = '<div align="center">
                                <font color="red" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                                Nenhum suporte remoto realizado no <u>per�odo informado</u> ou nenhum <u>local selecionado</>.</font><br><br></div>';
		...
		$query = 'SELECT 	DATE_FORMAT(aa.dt_hr_inicio_conexao, "%y-%m-%d %H:%i") as dt_hr_inicio_conexao,
				  ...
				  WHERE 	a.id_sessao = aa.id_sessao AND				  			
							...
							$where .
							$where_locais . ' AND
							d.id_computador = a.id_computador_srv AND
		...
		if ($NumRegistro)
    		...
    		<tr> 
      		<td height="10" colspan="3" bgcolor="#CCCCCC" class="destaque"><div align="center" class="style2"><?php echo $oTranslator->_('Resultado da consulta');?></div></td>
    		</tr>
    		<tr> 
            ...
            <td height="1" colspan="17" bgcolor="#333333"></td>
          	...
          	<tr bgcolor="#E1E1E1"> 
            <td colspan="3"></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_suporte_remoto.php?OrderBy=3&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('In�cio de Sess�o');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_suporte_remoto.php?OrderBy=7&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Esta��o Local');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_suporte_remoto.php?OrderBy=6&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Usu�rio Local');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_suporte_remoto.php?OrderBy=10&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Usu�rio Remoto');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_suporte_remoto.php?OrderBy=13&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Sigla S.O. Remoto');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_suporte_remoto.php?OrderBy=1&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Conex�o - �lt. Contato');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_suporte_remoto.php#"><?php echo $oTranslator->_('Chat');?></a></div></td>
            <td></td>            
          	</tr>
          	<tr> 
            <td height="1" colspan="17" bgcolor="#333333"></td>
			...
			while($row = mysql_fetch_array($result)) 
				...
				if ($strRegistroAnterior <> $strRegistroAtual)
        	    	...
        	    	<td nowrap></td>
	            	<td align="left" nowrap class="opcao_tabela" title="<?php echo $row['te_motivo_conexao'];?>"><?php echo $NumRegistro; ?></td>
	            	<td nowrap></td>
            		<td nowrap class="opcao_tabela" title="<?php echo $row['te_motivo_conexao'];?>"><a href="detalha_conexao.php?id_conexao=<?php echo $row['id_conexao'];?>"><?php echo $day_inicio_sessao.'/'.$month_inicio_sessao.'/'.$year_inicio_sessao. ' '. substr($hour_inicio_sessao,0,5).'h';?></a></td>
            		<td nowrap></td>
					<td nowrap class="opcao_tabela" title="<?php echo $row['te_motivo_conexao'];?>"><a href="detalha_conexao.php?id_conexao=<?php echo $row['id_conexao'];?>"><?php echo $row['te_ip_srv'].'<br>'.$row['te_nome_computador_srv'].' ('.$row['sg_local'].')';?></a></td>                
	            	<td nowrap></td>
    	        	<td nowrap class="opcao_tabela" title="<?php echo $row['te_motivo_conexao'];?>"><a href="detalha_conexao.php?id_conexao=<?php echo $row['id_conexao'];?>"><?php echo $row['nm_acesso_usuario_srv'] . '<br>' . $row['nm_completo_usuario_srv'];?></a></td>                
        	    	<td nowrap></td>
            		<td nowrap class="opcao_tabela" title="<?php echo $row['te_motivo_conexao'];?>"><a href="detalha_conexao.php?id_conexao=<?php echo $row['id_conexao'];?>"><?php echo ($row['id_usuario_ldap']?$row['id_usuario_ldap']:$row['nm_usuario_acesso']).'<br>'.($row['nm_usuario_completo_ldap']?$row['nm_usuario_completo_ldap']:$row['nm_usuario_completo']);?></a></td>	
	            	<td nowrap></td>
    	        	<td nowrap class="opcao_tabela" title="<?php echo $row['te_motivo_conexao'];?>"><a href="detalha_conexao.php?id_conexao=<?php echo $row['id_conexao'];?>"><?php echo $row['sg_so'];?></a></td>
        	    	<td nowrap></td>
            		<td nowrap class="opcao_tabela" title="<?php echo $row['te_motivo_conexao'];?>"><a href="detalha_conexao.php?id_conexao=<?php echo $row['id_conexao'];?>"><?php echo $day_conexao.'/'.$month_conexao.'/'.$year_conexao. ' '. substr($hour_conexao,0,5) . 'h<br>'.$day_ultimo_contato.'/'.$month_ultimo_contato.'/'.$year_ultimo_contato. ' '. substr($hour_ultimo_contato,0,5).'h';?></a></td>
            		<td nowrap></td>
	            	<td nowrap class="opcao_tabela">
					<?php 
					if ($row['te_mensagem']<>'') 
						{
						?>
						<a href="detalha_conexao.php?id_conexao=<?php echo $row['id_conexao'];?>"><img src="../imgs/chat.png" border="0" height="20" width="20"></a>
	                    <?php
						}
						?>
    	             </td>
