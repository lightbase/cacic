...
if (($_POST['ExcluiUSBDevice'] <> '') && $_SESSION['cs_nivel_administracao']==1) 
	...
	$result = mysql_query($query) or die ('Erro no acesso à tabela Dispositivos_USB ou sua sessão expirou!');
...
-->
    ...
    <tr>
      ...
      <p align="center"> 
        <input name="GravaAlteracoes" type="submit" value="  Gravar Informa&ccedil;&otilde;es  " onClick="return Confirma('Confirma Alteração de Dispositivo USB?');">
      </p>
