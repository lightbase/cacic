...
<table width="85%" border="0" align="center">
  ...
  <tr> 
      <td class="descricao"><?php echo $oTranslator->_('kciq_msg Log de atividades help');?></td>
  </tr>
</table>
	<p><br></p>
	...
	<?php if ($_REQUEST['date_input1'])
		...
		if ($NumRegistro)
			...
			<table width="85%" border="0" cellpadding="2" cellspacing="0" bordercolor="#333333" align="center">
          	<tr bgcolor="#E1E1E1"> 
            <td colspan="3"></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_atividades.php?OrderBy=1&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Data');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_atividades.php?OrderBy=2&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Operacao');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_atividades.php?OrderBy=3&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Tabela');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_atividades.php?OrderBy=4&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Programa');?> (.php)</a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_atividades.php?OrderBy=5&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Usuario');?></a></div></td>
            <td></td>
            <td nowrap class="cabecalho_tabela"><div align="left"><a href="log_atividades.php?OrderBy=6&date_input1=<?php echo $date_input1;?>&date_input2=<?php echo $date_input2;?>"><?php echo $oTranslator->_('Endereco IP origem');?></a></div></td>
            <td></td>
          	</tr>
          	<tr> 
			...
			while($row = mysql_fetch_array($result)) 
            	...
            	<td nowrap></td>
            	<td nowrap class="opcao_tabela_destaque"><font color="<?php echo ($row['cs_acao']=='INS'?'#006600':($row['cs_acao']=='UPD'?'#FF9933':'#FF0000'));?>"><?php echo $row['cs_acao'];?></font></td>
            	<td nowrap></td>
            	<td nowrap class="opcao_tabela"><?php echo $row['nm_tabela'];?></td>
            	<td nowrap></td>
				<td nowrap class="opcao_tabela"><?php echo $nm_script;?></td>
            	<td nowrap></td>
            	<td nowrap class="opcao_tabela"><a href="usuarios/detalhes_usuario.php?nm_chamador=Log_de_Atividades&id_usuario=<?php echo $row['id_usuario'];?>"><?php echo $nm_usuario_atividades;?></a></td>
            	<td nowrap></td>
			...
			<?php echo $oTranslator->_('Resumo das Operacoes');?></font></div></td>
			</tr>
			<tr> 
			<td height="1" colspan="3" bgcolor="#333333"></td>
			</tr>
			...
			<td><div align="right"><font size="2"><strong><?php echo $oTranslator->_('Percentual');?></strong></font></div></td>
			</tr>
			<tr> 
			<td height="1" colspan="3" bgcolor="#333333"></td>
			</tr>
			...
			foreach ($arr_cs_acao as $key => $value) 
				...
				?>
				<tr <?php if ($Cor) { echo 'bgcolor="#E1E1E1"'; } ?>>
				<td nowrap class="opcao_tabela_destaque"><div align="left"><font color="<?php echo ($key=='INS'?'#006600':($key=='UPD'?'#FF9933':'#FF0000'));?>"><?php echo $key;?></font></div></td>
			...
			<tr bgcolor="#CCCCCC"> 
			<td nowrap class="opcao_tabela_destaque"><?php echo $oTranslator->_('Total');?></td>
			...
			<tr bgcolor="#CCCCCC"> 
			<td><div align="left"><font size="2"><strong><?php echo $oTranslator->_('Programa');?> (.php)</strong></font></div></td>
			<td><div align="right"><font size="2"><strong><?php echo $oTranslator->_('Quantidade');?></strong></font></div></td>
			<td><div align="right"><font size="2"><strong><?php echo $oTranslator->_('Percentual');?></strong></font></div></td>
			</tr>
			<tr> 
