...
<title><?php echo $oTranslator->_('Troca de Senha de Acesso');?></title>
...
<table width="85%" border="0" align="center">
  <tr> 
    <td class="cabecalho"><?php echo $oTranslator->_('Troca de Senha de Acesso');?></td>
  </tr>
  <tr> 
    <td class="descricao">
    <?php echo $oTranslator->_('Informe a senha anterior, caso nao se lembre, solicite a um Administrador que a reinicialize.');?>
    </td>
  </tr>
</table>
...
<form action="troca_senha.php"  method="post" ENCTYPE="multipart/form-data" name="forma">
        <table width="453" border="0" cellpadding="2" cellspacing="2">
          <tr> 
            ...
            <td class="normal"><?php echo mysql_result($result, 0, 'nm_usuario_acesso'); ?></td>
          </tr>
          <tr> 
            <td nowrap class="label"><?php echo $oTranslator->_('Nome Completo');?>:</td>
            <td class="normal"><?php echo mysql_result($result, 0, 'nm_usuario_completo'); ?></td>
          </tr>
          <tr> 
            <td nowrap class="label"><?php echo $oTranslator->_('Senha Atual');?>:</td>
            <td> 
	          ...
	          <input name="frm_id_usuario" type="hidden" id="frm_id_usuario" value="<?php echo $_SESSION['id_usuario'];?>">			  
              </td>
          </tr>
          <tr>
            <td nowrap class="label"><?php echo $oTranslator->_('Nova Senha');?>:</td>
            <td>
          ...
          <tr> 
            <td nowrap class="label"><?php echo $oTranslator->_('kciq_msg verify');?>:</td>
            <td> 
        ...
        <p align="center"> 
          <input name="GravaAlteracoes" type="submit" id="GravaAlteracoes" value="<?php echo $oTranslator->_('Gravar alteracoes');?>" onClick="return Confirma('<?php echo $oTranslator->_('Confirma troca de senha?');?>');">
        </p>
      </form></td>
  </tr>
</table>
