...
es_UR     ksiq_msg so                                                                                         admin     info                Las informaciones de abajo se refieren a un sistema operativo instalado en el parque de computadoras inventariado por CACIC, donde el ID interna se refiere al valor enviado por el Gerente de Recolección (gercols.exe) compuesto por
...
es_UR     cadastro de aquisicao                                                                               admin     info                Registro de Adquisición
...
es_UR     coleta induzida por computador                                                                      admin     info                Recolección inducida por Computador
...
es_UR     conteudo da area de downloads                                                                       admin     info                Contenido del area de downloads
...
es_UR     enderooso eletronicos a notificar ao detectar alteracoes de patrimonio ou localizacao fisica        admin     info                Direcciones electrónicas para notificar al detectar modificaciones en el patrimonio o localizacion fisica
...
es_UR     evita que o gerente de coletas seja acionado enquanto tais aplicativos (janelas) estiverem ativos   admin     info                Evita que el Gerente de Recolección sea accionado cuando estas aplicaciones (ventanas) esten activas
...
es_UR     formulario para classificacao de softwares                                                          admin     info                Formulario para la clasificación de softwares
...
es_UR     graficos a serem exibidos                                                                           admin     info                Gráficos a ser mostrados
...
es_UR     ip de estacao e rede                                                                                admin     info                IP de estación y red
...
es_UR     informe a classificacao para o software.                                                            admin     info                Informe de clasificación para los softwares.
...
es_UR     kciq_msg cadastro de softwares help                                                                 admin     info                Modulo para registro manual de software para después ser utilizado como referencia junto con los datos de las licencias
...
es_UR     nao ha registro de aquisicao de softwares                                                           admin     info                No hay registro de Adquisición de Softwares
...
es_UR     nao foi possivel excluir o arquivo %1. verifique as permissoes de escrita na área de downloads!     admin     info                No fue posible excluir el archivo %1. Verifique los permisos de escritura en el directorio del downloads.
...
es_UR     nenhuma rede cadastrada ou sua sessao expirou!                                                      admin     info                Ninguna red fue registrada o su sesión expiro!
es_UR     kciq_msg downloads help                                                                             admin     info                En esta pagina es posible verificar el contenido de la area de downloads, bien como excluir objetos que no seran utilizados en las actualizaciones de las Subredes
...
es_UR     ocorreu um erro no select ou sua sessÃ£o expirou!                                                   admin     info                Ocurrió un error en el select o su sesión finalizo
es_UR     oito                                                                                                admin     info                Ocho
es_UR     ok!                                                                                                 admin     info                OK!
es_UR     onde executar essa acao-configuracao                                                                admin     info                Donde ejecutar esta acción-configuración
...
es_UR     relatorio de softwares por aquisicao                                                                admin     info                Reporte de Software por Adquisición
...
es_UR     downloads                                                                                        	  admin     info                Downloads
...
es_UR     resumo das tentativas de instalacao                                                                 admin     info                Resumen de las tentativas de Instalación
...
es_UR     sistemas operacionais onde essa acao-configuracao devera ser aplicada                               admin     info                Sistemas Operativos donde esta acción-configuración deberán ser aplicados
...
es_UR     ultima alteracao em                                                                                 admin     info                Ultima modificación en
...
es_UR     unidade da federacao                                                                                admin     info                Unidad de la Federación
...
es_UR     dica: use shift or ctrl para selecionar multiplos itens                                             statisticsinfo                Ayuda: use SHIFT o CTRL para seleccionar múltiples items
...
es_UR     admin                                                                                               geral     TagHeader           Administración
...
es_UR     kciq_msg connected ok                                                                               geral     info                Conexión realizada con éxito
...
es_UR     kciq_msg email                                                                                      geral     info                Correo electrónico
...
es_UR     marca ou desmarca acao para as redes abaixo                                                         geral     info                Marca o Desmarca Acción para las redes de abajo
...
es_UR     verificacao-atualizacao dos servidores de updates help                                              geral     info                Modulo para verificación/actualización de las versiones de los objetos localizados en los servidores de actualización de las subredes monitoreadas.
...
es_UR     ocorreu um erro no acesso a tabela %1 ou sua sessao expirou!                                        geral     info                Ocurrió un error en el acceso a la tabla %1 o su sesión finalizo
...
es_UR     kciq_msg phone                                                                                      geral     info                Teléfono
...
es_UR     kciq_msg check_notok                                                                                geral     info                Verificación no completada
es_UR     kciq_msg check_ok                                                                                   geral     info                Verificación completa
es_UR     versao do agente principal                                                                          geral     info                Version del agente principal
es_UR     kciq_msg version                                                                                    geral     info                Versión
...
es_UR     kciq_msg inst end advise                                                                            instaladorinfo                <p><b>Atención:</b> Lea los mensajes en el fin de esta pagina sobre el proceso de instalación, tales como las <b>recomendaciones</b> abajo:</p>
...
es_UR     kciq_msg check_advise                                                                               instaladorinfo                Alerta, pero podrá continuar
...
es_UR     kciq_msg update help                                                                                instaladorinfo                Actualizar las tablas de la base con respecto a la versión elegida.
es_UR     kciq_msg inst update tables on database                                                             instaladorinfo                Actualización de las tablas en la base de datos (%1)...
...
es_UR     kciq_msg inst database connect ok                                                                   instaladorinfo                Conexión realizada con suceso!
...
es_UR     kciq_msg inst database build fail                                                                   instaladorinfo                Construcción de la base de datos para el CACIC no fue realizada adecuadamente!
...
es_UR     kciq_msg inst admin data succesfuly created                                                         instaladorinfo                Datos administrativos insertados con éxito!
...
es_UR     kciq_msg check cacic configfile data                                                                instaladorinfo                Datos de archivo de configuración (%1) deben ser verificados.
es_UR     kciq_msg demo                                                                                       instaladorinfo                Demostración
es_UR     kciq_msg admin mgm email help                                                                       instaladorinfo                Correo electrónico del Administrador de CACIC para envío de mensajes
...
es_UR     kciq_msg php_flag_on_advise                                                                         instaladorinfo                Esa directiva es verificada solo para versión PHP = 5.x.y.
es_UR     kciq_msg finish                                                                                     instaladorinfo                Finalizar
es_UR     kciq_msg savecfgfile                                                                                instaladorinfo                Grabar <i>config.php</i>
es_UR     kciq_msg inst config file saved                                                                     instaladorinfo                Grabación del archivo de configuraciones no realizado adecuadamente!
es_UR     kciq_msg inst end hist title                                                                        instaladorinfo                Histórico de alteraciones en CACIC
...
es_UR     kciq_msg inst insert demo data                                                                      instaladorinfo                Inclusión de datos para demostración
...
es_UR     kciq_msg admin mgm name help                                                                        instaladorinfo                Local al cual la aplicación gerente está asociado.
...
es_UR     kciq_msg php_memory                                                                                 instaladorinfo                Memoria para ejecución de programas PHP
...
es_UR     kciq_msg inst database sqlupdatedata not defined                                                    instaladorerro                No hay instrucciones SQL (%1) para actualización de la base de datos de CACIC!
...
es_UR     kciq_msg gd_suporte                                                                                 instaladorinfo                Soporte las imágenes con GD
...
es_UR     kciq_msg phpversion_help                                                                            instaladorinfo                Para ejecutar CACIC es necesario instalar una versión de PHP indicada.
...
es_UR     kciq_msg license advise                                                                             instaladorinfo                Por favor, lea los términos de la licencia que sigue. Usted debe aceptar los términos de ésta para continuar la instalación!
...
es_UR     kciq_msg inst database build process ok                                                             instaladorinfo                Proceso de construcción de la base de datos (%1) finalizado con suceso!
...
es_UR     kciq_msg inst type not defined                                                                      instaladorerro                Seleccione uno de los dos tipos de instalación!
...
es_UR     kciq_msg admin mgm abbr help                                                                        instaladorinfo                Sigla del local al cual la aplicación gerente está asociada.
es_UR     kciq_msg test conn help                                                                             instaladorinfo                Testear conexión con la base de datos.
es_UR     kciq_msg test conn                                                                                  instaladorinfo                Testear la conexión
...
es_UR     kciq_msg install type                                                                               instaladorinfo                Tipo de instalación
es_UR     kciq_msg inst url not defined                                                                       instaladorinfo                URL de la aplicación debe ser informada!
es_UR     kciq_msg inst database user not defined                                                             instaladorerro                Usuario de conexión con la base de datos debe ser informado!
...
es_UR     kciq_msg inst path not executable                                                                   instaladorinfo                Verifique as permissões de leitura e execução do caminho físico informado!
es_UR     kciq_msg def_version                                                                                instaladorinfo                Versión
es_UR     kciq_msg version header                                                                             instaladorinfo                Versión a ser actualizada.
...
es_UR     kciq_msg license en_read                                                                            instaladorinfo                lea en inglês
