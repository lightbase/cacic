...
es_UR     cadastro de aquisicao                                                                               admin     info                Registro de Adquisicion
...
es_UR     coleta induzida por computador                                                                      admin     info                Recoleccion inducida por Computador
...
es_UR     enderooso eletronicos a notificar ao detectar alteracoes de patrimonio ou localizacao fisica        admin     info                Direcciones electronicas para notificar al detectar modificaciones en el patrimonio o localizacion fisica
...
es_UR     graficos a serem exibidos                                                                           admin     info                Graficos a ser mostrados
...
es_UR     ip gerente                                                                                          admin     info                IPGerente
es_UR     ip origem                                                                                           admin     info                IPOrigen
es_UR     ip de estacao e rede                                                                                admin     info                IP de estacion y red
...
es_UR     informe a classificacao para o software.                                                            admin     info                Informe de clasificacion para los softwares.
...
es_UR     nao ha registro de aquisicao de softwares                                                           admin     info                No hay registro de Aquisicion de Softwares
...
es_UR     ocorreu um erro no select ou sua sessÃ£o expirou!                                                   admin     info                Ocurrio un error en el select o su sesion finalizo
...
es_UR     relatorio de softwares por aquisicao                                                                admin     info                Reporte de Software por Adquisicion
...
es_UR     ultima alteracao em                                                                                 admin     info                Ultima modificacion en
...
es_UR     unidade da federacao                                                                                admin     info                Unidad de la Federacion
...
es_UR     dica: use shift or ctrl para selecionar multiplos itens                                             statisticsinfo                Ayuda: use SHIFT o CTRL para seleccionar multiples items
...
es_UR     admin                                                                                               geral     TagHeader           Administracion
...
es_UR     kciq_msg connected ok                                                                               geral     info                Conexion realizada con exito
...
es_UR     kciq_msg email                                                                                      geral     info                Correo eletrónico
...
es_UR     verificacao-atualizacao dos servidores de updates help                                              geral     info                Modulo para verificacion/actualizacion de las versiones de los objetos localizados en los servidores de actualizacion de las subredes monitoreadas.
...
es_UR     ocorreu um erro no acesso a tabela %1 ou sua sessao expirou!                                        geral     info                Ocurrio un error en el acceso a la tabla %1 o su sesion finalzo
...
es_UR     kciq_msg inst end advise                                                                            instaladorinfo                <p><b>Atencion:</b> Lea los mensajes en el fin de esta pagina sobre el proceso de instalacion, tales como las <b>recomendaciones</b> abajo:</p>
...
es_UR     kciq_msg inst database connect ok                                                                   instaladorinfo                Conexion realizada con suceso!
...
es_UR     kciq_msg inst admin data succesfuly created                                                         instaladorinfo                Datos administrativos insertados con suceso!
...
es_UR     kciq_msg check cacic configfile data                                                                instaladorinfo                Datos de archivo de configuracion (%1) deben ser verificados.
es_UR     kciq_msg demo                                                                                       instaladorinfo                Demostración
es_UR     kciq_msg admin mgm email help                                                                       instaladorinfo                Correo eletrónico del Administrador de CACIC para envío de mensajes
...
es_UR     kciq_msg inst insert demo data                                                                      instaladorinfo                Inclusión de datos para demonstración
...
es_UR     kciq_msg inst database sqlupdatedata not defined                                                    instaladorerro                No hay instruçciones SQL (%1) para actualización de la base de datos de CACIC!
...
es_UR     kciq_msg admin mgm phone help                                                                       instaladorinfo                Número de telefono del Administrador de CACIC para contactar.
...
es_UR     kciq_msg gd_suporte                                                                                 instaladorinfo                Soporte las imagenes con GD
...
es_UR     kciq_msg phpversion_help                                                                            instaladorinfo                Para ejecutar CACIC es necesario instalar una verión de PHP indicada.
...
es_UR     kciq_msg license advise                                                                             instaladorinfo                Por favor, lea los terminos de la licencia que sigue. Usted debe aceptar los terminos de ésta para continuar la instalacion!
...
es_UR     kciq_msg savecfgfile help                                                                           instaladorinfo                Graba el archivo de configraciones para CACIC.
