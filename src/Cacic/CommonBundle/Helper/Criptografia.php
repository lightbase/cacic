...
class Criptografia {
    ...
    public static function enCrypt($pStrPlainData, $pStrCsCipher, $pStrCsCompress, $pIntCompressLevel=0, $pStrPaddingKey = '', $pBoolForceEncrypt = false)
    {
    ...
    // p_cs_cipher => Y/N
    // ---------------------------------
    public static function deCrypt($pStrCriptedData, $pStrCsCipher, $pIntCsUnCompress='0', $pStrPaddingKey = '', $pBoolForceDecrypt = false)
    {
        $request = Request::createFromGlobals();
