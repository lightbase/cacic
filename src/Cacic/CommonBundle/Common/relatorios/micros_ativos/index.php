...
<table width="90%" border="0" align="center">
  ...
  <tr> 
    <td class="descricao">Este relat&oacute;rio exibe os microcomputadores por ordem da ultima coleta realizada e verifica os computadores ativos atrav&eacute;s da verificação por ICMP (1 comando de ping com tempo de vida de 1).
                ...
                <tr> 
                  ...
                  <td> <div align="left"> 
                      <select multiple name="list5[]" size="10" class="normal" onFocus="SetaClassDigitacao(this);" onBlur="SetaClassNormal(this);" >
                        ...
                        <option value="4">Há 4 dias</option>
                        <option value="5">Há mais de 4 dias</option>
                        <option value="10">Há mais de 9 dias</option>
                      </select>
                      </div></td>
                  <td>&nbsp;</td>
