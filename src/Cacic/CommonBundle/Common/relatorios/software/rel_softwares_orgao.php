	...
	while($row = mysql_fetch_array($result)) {
	 ...
	 ?>
        <tr <?php if ($Cor) { echo 'bgcolor="#E1E1E1"'; } ?>> 
          ...
          <td nowrap>&nbsp;</td>
          <td nowrap class="opcao_tabela"><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="../../relatorios/computador/computador.php?id_computador=<?php echo $row['id_computador'];?>" target="_blank"><?php if ($row['te_nome_computador']) { echo $row['te_nome_computador']; } else { echo '<i>Em Branco</i>'; } ?></div></td>
          <td nowrap>&nbsp;</td>
	  <td nowrap class="opcao_tabela"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $row['te_ip_computador']; ?></font></td>
	  <td nowrap>&nbsp;</td>
	  <td nowrap>&nbsp;</td>
	  <td nowrap class="opcao_tabela"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?php echo date("d/m/Y H:i", strtotime( $row['dt_hr_ult_acesso'] )); ?></font></div></td>
	  <td nowrap>&nbsp;</td>
          <?php 
	$Cor=!$Cor;
	$NumRegistro++;
