...
?>
<?php
	 $query = "SELECT a.te_nome_computador as nm_maquina, b.te_node_address, b.id_so, a.te_ip_computador, 
	...
	while($row = mysql_fetch_array($result)) {
	 ...
	 ?>
        <tr <?php if ($Cor) { echo 'bgcolor="#E1E1E1"'; } ?>> 
          ...
          <td wrap>&nbsp;&nbsp;</td>
          <td wrap><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="../../../relatorios/computador/computador.php?id_computador=<?php echo $row['id_computador'];?>" target="_blank"><?php echo $row['nm_maquina']; ?></div></td>
	  <td nowrap>&nbsp;&nbsp;</td>
