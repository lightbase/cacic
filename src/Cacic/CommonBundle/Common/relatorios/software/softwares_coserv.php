	...
	while($row = mysql_fetch_array($result)) {
	 ...
	 ?>
        <tr <?php if ($Cor) { echo 'bgcolor="#E1E1E1"'; } ?>> 
          ...
          <td nowrap>&nbsp;</td>
          <td nowrap class="opcao_tabela"><a href="rel_softwares_coserv.php?id_software_inventariado=<?php echo $row['id_soft'];?>&nm_software_inventariado=<?php echo $row['nm_soft'];?>" target="_blank"><?php echo $row['nm_soft']; ?></a></td>
          <td nowrap>&nbsp;</td>
