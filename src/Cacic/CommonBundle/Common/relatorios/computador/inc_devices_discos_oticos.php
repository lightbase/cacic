...
<table width="94%" border="0" align="center" cellpadding="0" cellspacing="1">
  ...
  <tr> 
    <td bgcolor="#E1E1E1" class="cabecalho_tabela">&nbsp;<a href="computador.php?exibir=devices_discos_oticos&id_computador=<?php echo $_GET['id_computador']?>"> 
      <img src="../../imgs/<?php if($_SESSION['devices_discos_oticos'] == true) echo 'menos';
  ...
  <?php if ($_SESSION['devices_discos_oticos'] == true) {
