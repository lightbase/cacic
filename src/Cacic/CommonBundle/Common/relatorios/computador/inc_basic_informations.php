...
<?php echo getComponentValue($arrDadosComputador[0]["id_computador"],'ComputerSystem','Caption');  ?>
</b></div></td>
</tr>
</table>
<br>
...
<tr><td>
    <table width="94%" border="0" align="center" cellpadding="0" cellspacing="1">
        ...
        <tr><td colspan="5" bgcolor="#E1E1E1" class="cabecalho_tabela">&nbsp;<?php echo $oTranslator->_('Informacoes basicas');?></td></tr>
        <tr><td colspan="5" height="1" bgcolor="#333333"></td></tr>
        
        <?php
        $today=date('m-d-Y');	
        $access_day = explode('-',$arrDadosComputador[0]["dt_hr_ult_acesso"]);	
        ...
        <td class="dado"><?php echo getComponentValue($arrDadosComputador[0]["id_computador"],'ComputerSystem','Caption');?></td>
        <td class="opcao_tabela"><?php echo $oTranslator->_('Sistema operacional');?></td>
        <td class="dado"><?php echo getComponentValue($arrDadosComputador[0]["id_computador"],'OperatingSystem','Caption'); ?></td>	
        </tr>
        ...
        <td class="dado"><?php echo $arrDadosComputador[0]["te_versao_cacic"]; ?></td>
        <td class="opcao_tabela"><?php echo $oTranslator->_('Versao gerente de coletas');?></td>
        <td class="dado"><?php echo $arrDadosComputador[0]["te_versao_gercols"]; ?></td>
        </tr>
        ...
        <td class="dado"><?php echo date("d/m/Y à\s H:i\h", strtotime($arrDadosComputador[0]["dt_hr_inclusao"])); ?></td>
        <td class="opcao_tabela"><?php echo $oTranslator->_('Data/Hora do ultimo acesso');?></td>
        <td class="dado"><?php echo date("d/m/Y à\s H:i\h", strtotime($arrDadosComputador[0]["dt_hr_ult_acesso"])). ' ' .$img_date; ?></td>    
        </tr>			
    </table>
</td></tr>
</table>		
