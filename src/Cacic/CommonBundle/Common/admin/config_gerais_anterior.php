...
<table width="85%" border="0" align="center">
  ...
  <table width="85%" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    <tr> 
      <td><p> 
          <?php // Aten��o: o campo abaixo deve estar em "disabled", pois, a altera��o desse valor s� ser� permitida ao n�vel 
    ...
    <tr> 
      <td><?php /*<table width="100%" border="0" cellpadding="0" cellspacing="1">*/?>
          <tr> 
            <td class="label">
            	<?php echo $oTranslator->_('Realizar notificacao caso haja utiliza��o dos seguintes dispositivos USB nas estacoes de trabalho');?>:
            </td>            
          </tr>
          <tr> 
            <td height="1" bgcolor="#333333"></td>
    ...
    <tr> 
      <td>&nbsp;</td>
		...
		MontaListasDisponiveisSelecionados('[so][acessos][acessos_locais][locais]','Totais de Computadores por Sistemas Operacionais#�ltimos Acessos dos Agentes do Local#�ltimos Acessos dos Agentes por Local na Data#Totais de Computadores Monitorados por Local','<?php echo $te_exibe_graficos;?>');
		</script>					  	
