...
function validaForm() {
	...
	if((document.forms[0].nome.value=="") || (document.forms[0].nome.value.substring(0,1)==" ")){
		msg="- <?php echo $oTranslator->_('Nome e um campo obrigatorio!');?>";
	}
	
	if((document.forms[0].quantidadeLicenca.value=="") || (document.forms[0].quantidadeLicenca.value.substring(0,1)==" ")){
		msg=msg+"\n- <?php echo $oTranslator->_('Quantidade de licencas e um campo obrigatorio!');?>";
	}
...
<table width="85%" border="0" align="center">
  ...
  <tr> 
    <td class="descricao">
     <?php echo $oTranslator->_('kciq_msg cadastro de softwares help');?>
    </td>
  </tr>
  <tr> 
    <td> </td>
...
<tr>
  <td><?php echo $oTranslator->_('Descricao:');?></td>
  <td><input type=text name="descricao" size="50"></td>
<tr>
  <td><?php echo $oTranslator->_('Quantidade de Licencas:');?></td>
  <td><input type=text name="quantidadeLicenca" size="10"></td>
</tr>
<tr>
  <td><?php echo $oTranslator->_('Numero da Midia:');?></td>
  <td><input type=text name="numeroMidia" size="10"></td>
</tr>
<tr>
  <td><?php echo $oTranslator->_('Localizacao da Midia:');?></td>
...
<tr>
  <td align="right"><input type="reset" name="cancelar" value="<?php echo $oTranslator->_('Cancelar');?>"/></td>
  <td align="left"><input type="submit" name="gravar" value="<?php echo $oTranslator->_('Gravar');?>" width="100"></td>
</tr>
</table>
</form>
<p>&nbsp;</p>
