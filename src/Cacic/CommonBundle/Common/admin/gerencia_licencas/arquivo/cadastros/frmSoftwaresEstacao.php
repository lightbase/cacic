...
function validaForm() {
	...
	if((document.forms[0].patrimonio.value=="") || (document.forms[0].patrimonio.value.substring(0,1)==" ")){
		msg="- <?php echo $oTranslator->_('Patrimonio e um campo obrigatorio!');?>";
	}
	
	if((document.forms[0].software.value==-1) || (document.forms[0].software.value.substring(0,1)==" ")){
		msg=msg+"\n- <?php echo $oTranslator->_('Software e um campo obrigatorio!');?>";
	}
	
	if((document.forms[0].dataAutorizacao.value=="") || (document.forms[0].dataAutorizacao.value.substring(0,1)==" ")){
		msg=msg+"\n- <?php echo $oTranslator->_('Data de autorizacao e um campo obrigatorio!');?>";
	}
...
<table width="85%" border="0" align="center">
  <tr> 
    <td class="cabecalho"><?php echo $oTranslator->_('Cadastro de Softwares po Estacao');?></td>
  </tr>
  <tr> 
    <td class="descricao">
      <?php echo $oTranslator->_('Modulo para cadastramento manual de softwares por estacao');?>
    </td>
  </tr>
  <tr> 
    <td> </td>
...
<table width="85%" align="center">
    <tr>
      <td><?php echo $oTranslator->_('Patrimonio:');?></td>
	...
	<tr>
	  <td align="center" colspan="2"><input type="submit" name="gravar" value="<?php echo $oTranslator->_('Gravar');?>" width="100" <?php echo ($_SESSION['cs_nivel_administracao']<>1&&$_SESSION['cs_nivel_administracao']<>3?'disabled':'')?>></td>
	</tr>
</table>
<p>&nbsp;</p>
</body>
