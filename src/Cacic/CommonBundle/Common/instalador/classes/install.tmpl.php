<?php
/**
 * @version $Id: install.tmpl.php,v 1.1.1.1 2012/09/14 16:01:08 d302112 Exp $
...
Class Template extends patTemplate {
   ...
   function navBar($type="preInstall") {
     ...
     $kciq_msg_suporte = $this->oLang->_('kciq_msg ldap_suporte', T_SIGLA);
     $kciq_msg_suporte = $kciq_msg_suporte == "kciq_msg ldap_suporte"?"":" (".$kciq_msg_suporte.")";
     $kciq_msg_suporte = $this->oLang->_('kciq_msg ldap_suporte').$kciq_msg_suporte;
     $this->addVar('tmplNavBarCheckInstall',  'KCIQ_LDAP_SUPORTE', $kciq_msg_suporte);
     ...
     $this->addVar('tmplNavBarFinish',  'KCIQ_INST_END_HIST_PLUS', $this->oLang->_('e mais...'));
