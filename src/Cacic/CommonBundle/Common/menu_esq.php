...
if($_POST['frm_nm_usuario_acesso'] && $_POST['frm_te_senha'])
	...
	// *********************************************************************************************
	// ** VERIFICAR EXIST�NCIA DO USU�RIO NA BASE DO CACIC COM O NOME FORNECIDO
	// ** 		Se Existe
	// **			Verificar se senha confere
	// ** 				Se Confere
	// **					OK - Concluir acesso ao CACIC
	// **				Se N�o Confere
	// **					Verificar se usu�rio e senha fazem BIND no ServidorAutenticacao de Autentica��o
	// **						Se Fazem BIND
	// **							Informar que as senhas est�o diferentes e oferecer sincroniza��o
	// **								Se Sincroniza��o Aceita
	// **									Sincronizar e Concluir acesso ao CACIC
	// **								Se Sincroniza��o N�o Aceita
	// **									Informar USU�RIO INEXISTENTE OU SENHA INV�LIDA
	// **									FIM
	// **		Se N�o Existe
	// **			Verificar se usu�rio e senha fazem BIND no ServidorAutenticacao de Autentica��o
	// **				Se Fazem BIND
	// **					Informar que o usu�rio n�o tem conta no CACIC e que dever� solicitar seu cadastramento 
	// **					FIM
	// **				Se N�o Fazem BIND
	// **					Informar USU�RIO INEXISTENTE OU SENHA INV�LIDA
	// *********************************************************************************************
