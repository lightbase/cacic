...
if ($te_node_address <> '')
	...
	$campos_alterados ."\n\n
	Para visualizar mais informações sobre esse computador, acesse o endereço ".CACIC_PATH."/relatorios/computador/computador.php?id_so=" . $arrSO['id_so'] . "&te_node_address=" . $te_node_address . "\n
