...
$arr_acessos = array();
$arr_acessos[$oTranslator->_('Hoje................')] = qt_comp($result, 0);
$arr_acessos[$oTranslator->_('Ha 1 dia............')] = qt_comp($result, 1);  
$arr_acessos[$oTranslator->_('Ha 2 dias...........')] = qt_comp($result, 2); 
$arr_acessos[$oTranslator->_('Ha 3 dias...........')] = qt_comp($result, 3); 
$arr_acessos[$oTranslator->_('Ha 4 dias...........')] = qt_comp($result, 4); 
$arr_acessos[$oTranslator->_('De 5 a 30 dias......')] = ha_mais_de($result, 4,30);      // De 4 dias a 1 mês...
$arr_acessos[$oTranslator->_('De 30 a 180 dias....')] = ha_mais_de($result, 29,180);	  // De 1 mês a 6 meses...
$arr_acessos[$oTranslator->_('De 180 a 365 dias...')] = ha_mais_de($result, 179,365);	  // De 6 meses a 1 ano...		
$arr_acessos[$oTranslator->_('Ha mais de 365 dias.')] = ha_mais_de($result, 364,99999); // De 1 ano em diante...
