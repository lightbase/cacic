pt_BR     (softwares nao classificados e softwares lixo)                                                      admin     info                (Softwares não classificados e softwares lixo)
pt_BR     (diferente de administrador):                                                                       admin     info                (diferente de administrador):
pt_BR     (icone na bandeja da estacao):                                                                      admin     info                (ícone na bandeja da estação):
pt_BR     --- selecione ---                                                                                   admin     info                --- Selecione ---
pt_BR     1 hora apos a inicializacao do cacic                                                                admin     info                1 hora após a inicialização do CACIC
pt_BR     10 minutos apos a inicializacao do cacic                                                            admin     info                10 minutos após a inicialização do CACIC
pt_BR     20 minutos apos a inicializacao do cacic                                                            admin     info                20 minutos após a inicialização do CACIC
pt_BR     30 minutos apos a inicializacao do cacic                                                            admin     info                30 minutos após a inicialização do CACIC
...
pt_BR     a inclusao de %1 e restrita ao administrador do sistema                                             admin     info                A inclusão de %1 e restrita ao Administrador do sistema
pt_BR     a inclusao de %1 e restrita ao nivel administrativo.                                                admin     info                A inclusão de %1 e restrita ao nível administrativo.
pt_BR     a sigla do local e obrigatoria                                                                      admin     info                A sigla do local é obrigatória
pt_BR     admin - excluir historico de software                                                               admin     info                ADMIN - Excluir histórico de software
pt_BR     atencao: verifique os campos para notificacao de alteracao de hardware                              admin     info                ATENCAO: Verifique os campos para notificação de alteração de hardware
pt_BR     abrangencia                                                                                         admin     info                Abrangência
pt_BR     abrir janela de coleta ao detectar alteracoes de localizacao fisica                                 admin     info                Abrir janela de coleta ao detectar alterações de localização física
...
pt_BR     ainda nao existem redes associadas ao local!                                                        admin     info                Ainda não existem redes associadas ao local!
pt_BR     ainda nao existem usuarios associados ao local!                                                     admin     info                Ainda não existem usuários associados ao local!
...
pt_BR     kciq_msg modulos help                                                                               admin     info                Aqui você podera configurar os vários módulos disponíveis do CACIC. Clique sobre o módulo desejado e, em seguida, realize as configurações.
pt_BR     aquisicao                                                                                           admin     info                Aquisição
pt_BR     aquisicao:                                                                                          admin     info                Aquisição:
pt_BR     aquisicoes                                                                                          admin     info                Aquisições
...
pt_BR     as informacoes abaixo referem-se as caracteristicas de instalacao de sistema a serem monitorados    admin     info                As informações abaixo referem-se às características de instalação de sistema a serem monitorados
...
pt_BR     as informacoes referem-se a um local originario de chamadas ao sistema cacic                        admin     info                As informações referem-se a um local originário de chamadas ao sistema CACIC
pt_BR     as opcoes abaixo determinam como o modulo gerente devera se comportar.                              admin     info                As opções abaixo determinam como o módulo gerente deverá se comportar.
pt_BR     as opcoes abaixo determinam qual sera o comportamento dos agentes do                                admin     info                As opções abaixo determinam qual será o comportamento dos agentes do
pt_BR     atencao                                                                                             admin     info                Atenção
pt_BR     atencao: informe os emails separados por virgulas                                                   admin     info                Atenção: informe os emails separados por vírgulas
pt_BR     atencao: informe os enderecos separados por virgulas                                                admin     info                Atenção: informe os endereços separados por vírgulas
pt_BR     atencao: informe os nomes separados por virgulas                                                    admin     info                Atenção: informe os nomes separados por vírgulas
pt_BR     atualizando                                                                                         admin     info                Atualizando
pt_BR     atualizacao especial                                                                                admin     info                Atualização Especial
pt_BR     atualizacao de base de dados                                                                        admin     info                Atualização de Base de Dados
pt_BR     autorizado                                                                                          admin     info                Autorizado
pt_BR     autorizados                                                                                         admin     info                Autorizados
pt_BR     autorizacao                                                                                         admin     info                Autorização
pt_BR     acoes selecionadas para essa rede:                                                                  admin     info                Ações selecionadas para essa rede:
...
pt_BR     cadastro de aquisicao                                                                               admin     info                Cadastro de Aquisição
pt_BR     cadastro de aquisicoes                                                                              admin     info                Cadastro de Aquisições
...
pt_BR     cadastro de softwares po estacao                                                                    admin     info                Cadastro de Softwares po Estação
pt_BR     cadastro de subredes                                                                                admin     info                Cadastro de Subredes
pt_BR     cadastro de unidade organizacional nivel 2                                                          admin     info                Cadastro de unidade organizacional nível 2
pt_BR     cadastro de usuarios                                                                                admin     info                Cadastro de usuários
pt_BR     caminho no servidor de atualizacoes                                                                 admin     info                Caminho no servidor de atualizações
...
pt_BR     classificacao de software                                                                           admin     info                Classificação de software
...
pt_BR     computador:                                                                                         admin     info                Computador:
pt_BR     computadores onde esta acao-configuracao nao devera ser aplicada                                    admin     info                Computadores onde esta ação-configuração não deverá ser aplicada
pt_BR     condicao                                                                                            admin     info                Condição
pt_BR     configuracao basica                                                                                 admin     info                Configuração básica
pt_BR     configuracao da tela de patrimonio                                                                  admin     info                Configuração da tela de patrimônio
pt_BR     configuracao padrao                                                                                 admin     info                Configuração padrão
pt_BR     configuracoes do modulo gerente                                                                     admin     info                Configurações do módulo Gerente
pt_BR     configuracoes dos modulos agentes                                                                   admin     info                Configurações dos módulos Agentes
pt_BR     confirma a remocao deste computador?                                                                admin     info                Confirma a remoção deste computador?
pt_BR     confirma configuracao de                                                                            admin     info                Confirma configuração de
pt_BR     confirma configuracao de acao?                                                                      admin     info                Confirma configuração de Acao?
pt_BR     confirma configuracao de agentes?                                                                   admin     info                Confirma configuração de Agentes?
pt_BR     confirma configuracao de etiqueta 1?                                                                admin     info                Confirma configuração de Etiqueta 1?
pt_BR     confirma configuracao de etiqueta 1a?                                                               admin     info                Confirma configuração de Etiqueta 1a?
pt_BR     confirma configuracao de etiqueta 2?                                                                admin     info                Confirma configuração de Etiqueta 2?
pt_BR     confirma configuracao de etiqueta 3?                                                                admin     info                Confirma configuração de Etiqueta 3?
pt_BR     confirma configuracao para coleta de patrimonio?                                                    admin     info                Confirma configuração para coleta de patrimônio?
pt_BR     confirma exclusao                                                                                   admin     info                Confirma exclusão
pt_BR     confirma exclusao de                                                                                admin     info                Confirma exclusão de
pt_BR     confirma exclusao de rede                                                                           admin     info                Confirma exclusão de Rede
pt_BR     confirma exclusao de perfil de sistema monitorado?                                                  admin     info                Confirma exclusão de perfil de sistema monitorado?
pt_BR     confirma exclusao de usuario?                                                                       admin     info                Confirma exclusão de usuário?
pt_BR     confirma exclusao do local e todas as suas dependencias?                                            admin     info                Confirma exclusão do local E TODAS AS SUAS DEPENDÊNCIAS?
pt_BR     confirma exclusao?                                                                                  admin     info                Confirma exclusão?
pt_BR     confirma inclusao de local?                                                                         admin     info                Confirma inclusão de local?
pt_BR     confirma inclusao de usuario?                                                                       admin     info                Confirma inclusão de usuário?
pt_BR     confirma informacoes para                                                                           admin     info                Confirma informações para
pt_BR     confirma informacoes para o local?                                                                  admin     info                Confirma informações para o Local?
pt_BR     confirma informacoes para perfil de sistema monitorado?                                             admin     info                Confirma informações para perfil de sistema monitorado?
pt_BR     confirma informacoes para usuario?                                                                  admin     info                Confirma informações para usuário?
pt_BR     confirma troca de senha?                                                                            admin     info                Confirma troca de senha?
pt_BR     consulta de softwares autorizados por orgao                                                         admin     info                Consulta de softwares autorizados por orgão
pt_BR     consulta quantidade de licencas                                                                     admin     info                Consulta quantidade de licenças
...
pt_BR     data de autorizacao:                                                                                admin     info                Data de Autorização:
pt_BR     data de desinstalacao:                                                                              admin     info                Data de Desinstalação:
...
pt_BR     descripcao                                                                                          admin     info                Descripção
pt_BR     descricao                                                                                           admin     info                Descrição
pt_BR     descricao do tipo de acesso                                                                         admin     info                Descrição do tipo de acesso
pt_BR     descricao:                                                                                          admin     info                Descrição:
pt_BR     destacar as seguintes duplicidades no relatorio de patrimonio                                       admin     info                Destacar as seguintes duplicidades no relatório de patrimônio
...
pt_BR     detalhes de usuario                                                                                 admin     info                Detalhes de usuário
pt_BR     detalhes do local                                                                                   admin     info                Detalhes do Local
pt_BR     detalhes do software                                                                                admin     info                Detalhes do Software
pt_BR     deve-se ter o cuidado quanto a sensibilidade no uso de letras maiusculas e minusculas.              admin     info                Deve-se ter o cuidado quanto a sensibilidade no uso de letras maiúsculas e minúsculas.
pt_BR     dez                                                                                                 admin     info                Dez
pt_BR     dica: use shift ou ctrl para selecionar multiplos itens                                             admin     info                Dica: use SHIFT ou CTRL para selecionar múltiplos itens
pt_BR     digite a porta ftp do servidor de atualizacoes                                                      admin     info                Digite a porta FTP do servidor de atualizações
...
pt_BR     digite o identificador do servidor de atualizacoes                                                  admin     info                Digite o identificador do servidor de atualizações
pt_BR     digite pelo menos 03 caracteres...                                                                  admin     info                Digite pelo menos 03 caracteres...
pt_BR     disponibilizar informacoes ao usuario comum?                                                        admin     info                Disponibilizar informações ao usuário comum?
pt_BR     disponibilizar informacoes no systray?                                                              admin     info                Disponibilizar informações no Systray?
pt_BR     disponiveis                                                                                         admin     info                Disponiveis
pt_BR     divisao                                                                                             admin     info                Divisão
pt_BR     divisoes                                                                                            admin     info                Divisões
...
pt_BR     endereco                                                                                            admin     info                Endereço
pt_BR     endereco ip                                                                                         admin     info                Endereço IP
pt_BR     endereco ip origem                                                                                  admin     info                Endereço IP origem
pt_BR     endereco mac                                                                                        admin     info                Endereço MAC
pt_BR     endereco eletronico                                                                                 admin     info                Endereço eletrônico
pt_BR     endereco/mascara                                                                                    admin     info                Endereço/Máscara
pt_BR     enderecos mac a desconsiderar                                                                       admin     info                Endereços MAC a desconsiderar
pt_BR     enderooso eletronicos a notificar ao detectar alteracoes de patrimonio ou localizacao fisica        admin     info                Endereços eletrônicos a notificar ao detectar alterações de patrimônio ou localização física
...
pt_BR     kciq_msg excluir computadores advise                                                                admin     info                Esta opção permite a exclusão parametrizada das informações armazenadas na base sobre as estações monitoradas. Deve-se tomar muito cuidado com a abrangência da condição a ser formulada.
...
pt_BR     estacao                                                                                             admin     info                Estação
...
pt_BR     exibe janela de patrimonio                                                                          admin     info                Exibe janela de patrimônio
pt_BR     exibe os softwares inventariados nos computadores que nao estao associados a nenhuma maquina.       admin     info                Exibe os softwares inventariados nos computadores que não estão associados a nenhuma máquina.
...
pt_BR     formulario para classificacao de softwares                                                          admin     info                Formulário para classificação de softwares
pt_BR     formulario para importar dados de aquisicoes                                                        admin     info                Formulário para importar dados de aquisições
pt_BR     formulario para importar dados de itens de aquisicoes                                               admin     info                Formulário para importar dados de ítens de aquisições
pt_BR     formulario para importar dados de software                                                          admin     info                Formulário para importar dados de software
...
pt_BR     gerencia                                                                                            admin     info                Gerência
pt_BR     gerencias                                                                                           admin     info                Gerências
pt_BR     graficos a serem exibidos                                                                           admin     info                Gráficos a serem exibidos
pt_BR     gravar                                                                                              admin     info                Gravar
pt_BR     gravar alteracoes                                                                                   admin     info                Gravar alterações
pt_BR     gravar alteracoes?                                                                                  admin     info                Gravar alterações?
pt_BR     gravar informacoes                                                                                  admin     info                Gravar informações
pt_BR     hod - microsoft word - corel draw - photoshop                                                       admin     info                HOD - Microsoft Word - Corel Draw - PhotoShop
pt_BR     habilitar acao-configuracao em todas as redes                                                       admin     info                Habilitar ação-configuração em todas as redes
pt_BR     consulta quantidade de licencas help                                                                admin     info                Havendo saldo positivo numa versão não implica disponibilidade de licença. O saldo pode estar cobrindo saldo negativo de versões anteriores.
...
pt_BR     historico                                                                                           admin     info                Histórico
pt_BR     historio de softwares excluidos com sucesso da base de dados                                        admin     info                Histórico de softwares excluídos com sucesso da base de dados
...
pt_BR     ip de estacao e rede                                                                                admin     info                IP de estação e rede
pt_BR     ide                                                                                                 admin     info                Ide
pt_BR     identificacao                                                                                       admin     info                Identificação
pt_BR     identificador de instalacao                                                                         admin     info                Identificador de instalação
pt_BR     identificador de licenca                                                                            admin     info                Identificador de licença
pt_BR     identificador de versao/configuracao                                                                admin     info                Identificador de versão/configuração
pt_BR     imediatamente apos a inicializacao do cacic                                                         admin     info                Imediatamente após a inicialização do CACIC
pt_BR     importante                                                                                          admin     info                Importante
pt_BR     importante:                                                                                         admin     info                Importante:
pt_BR     incluir                                                                                             admin     info                Incluir
pt_BR     incluir aquisicao                                                                                   admin     info                Incluir Aquisição
pt_BR     incluir informacoes de novo local                                                                   admin     info                Incluir Informações de Novo Local
...
pt_BR     incluir novo usuario                                                                                admin     info                Incluir novo usuário
pt_BR     inclusao                                                                                            admin     info                Inclusão
pt_BR     inclusao de                                                                                         admin     info                Inclusão de
pt_BR     inclusao de local                                                                                   admin     info                Inclusão de Local
pt_BR     inclusao de novo usuario                                                                            admin     info                Inclusão de novo usuário
...
pt_BR     licencas autorizadas por estacao                                                                    admin     info                Licenças autorizadas por estação
pt_BR     limite de conexoes ftp                                                                              admin     info                Limite de conexões FTP
pt_BR     linha de negocio                                                                                    admin     info                Linha de negócio
pt_BR     linhas de negocios                                                                                  admin     info                Linhas de negócios
pt_BR     locais                                                                                              admin     info                Locais
pt_BR     locais secundarios                                                                                  admin     info                Locais secundários
pt_BR     local                                                                                               admin     info                Local
pt_BR     local da midia                                                                                      admin     info                Local da Mídia
pt_BR     local de aplicacao                                                                                  admin     info                Local de Aplicação
pt_BR     local/rede                                                                                          admin     info                Local/Rede
pt_BR     localizacao da midia:                                                                               admin     info                Localização da Mídia:
pt_BR     log de acessos                                                                                      admin     info                Log de Acessos
pt_BR     log de atividades                                                                                   admin     info                Log de Atividades
pt_BR     log de insucessos nas instalacoes dos agentes                                                       admin     info                Log de Insucessos nas Instalações dos Agentes
pt_BR     maior que                                                                                           admin     info                MAIOR QUE
pt_BR     menor que                                                                                           admin     info                MENOR QUE
pt_BR     manutencao de redes/subredes                                                                        admin     info                Manutenção de redes/subredes
pt_BR     maquinas                                                                                            admin     info                Máquinas
pt_BR     mascara                                                                                             admin     info                Máscara
pt_BR     mecanismo para atualizacao de arquivos diversos no servidor, no ambito da aplicacao.                admin     info                Mecanismo para atualização de arquivos diversos no servidor, no âmbito da aplicação.
pt_BR     mensagens                                                                                           admin     info                Mensagens
pt_BR     modulo para atualizacao das informacoes coletadas dos modulos gerentes descentralizados             admin     info                Módulo para atualização das informações coletadas dos módulos gerentes descentralizados
pt_BR     modulo para cadastramento de unidades organizacionais de nivel 1                                    admin     info                Módulo para cadastramento de Unidades Organizacionais de Nível 1
pt_BR     modulo para cadastramento de unidades organizacionais de nivel 1a                                   admin     info                Módulo para cadastramento de Unidades Organizacionais de Nível 1a
pt_BR     modulo para cadastramento de unidades organizacionais de nivel 2                                    admin     info                Módulo para cadastramento de Unidades Organizacionais de Nível 2
pt_BR     modulo para cadastramento manual de softwares por estacao                                           admin     info                Módulo para cadastramento manual de softwares por estação
pt_BR     modulos                                                                                             admin     info                Módulos
...
pt_BR     nenhum usuario cadastrado ou sua sessao expirou!                                                    admin     info                Nenhum usuário cadastrado ou sua sessão expirou!
...
pt_BR     nenhuma acao realizada no periodo informado.                                                        admin     info                Nenhuma ação realizada no período informado.
pt_BR     nenhuma acao selecionada para essa rede!                                                            admin     info                Nenhuma ação selecionada para essa rede!
pt_BR     nenhuma atividade realizada no periodo informado                                                    admin     info                Nenhuma atividade realizada no período informado
pt_BR     nenhuma rede cadastrada ou sua sessao expirou!                                                      admin     info                Nenhuma rede cadastrada ou sua sessão expirou!
...
pt_BR     neste modulo deverao ser cadastrados os softwares avulsos, manipulados pelo sistema                 admin     info                Neste módulo deverão ser cadastrados os softwares avulsos, manipulados pelo sistema
pt_BR     neste modulo deverao ser cadastrados os usuarios que acessarao o sistema.                           admin     info                Neste módulo deverao ser cadastrados os usuários que acessarão o sistema.
...
pt_BR     nome da maquina                                                                                     admin     info                Nome da máquina
pt_BR     nome da organizacao                                                                                 admin     info                Nome da organização
pt_BR     nome da organizacao-empresa-orgao                                                                   admin     info                Nome da organização-empresa-órgão
pt_BR     nome da rede                                                                                        admin     info                Nome da rede
pt_BR     nome de executavel                                                                                  admin     info                Nome de executável
...
pt_BR     nome do proprietario:                                                                               admin     info                Nome do proprietário:
pt_BR     nome do sistema:                                                                                    admin     info                Nome do sistema:
pt_BR     nome e um campo obrigatorio!                                                                        admin     info                Nome é um campo obrigatório!
pt_BR     nome ou ip do servidor de aplicacao (gerente)                                                       admin     info                Nome ou IP do servidor de aplicação (gerente)
pt_BR     nome ou ip do servidor de atualizacao (ftp)                                                         admin     info                Nome ou IP do servidor de atualização (FTP)
pt_BR     nova senha                                                                                          admin     info                Nova senha
pt_BR     nove                                                                                                admin     info                Nove
pt_BR     numero da midia                                                                                     admin     info                Número da Mídia
pt_BR     numero da midia:                                                                                    admin     info                Número da Mídia:
pt_BR     numero da nota fiscal:                                                                              admin     info                Número da nota fiscal:
pt_BR     numero do patrimonio                                                                                admin     info                Número do Patrimônio
pt_BR     numero do processo:                                                                                 admin     info                Número do Processo:
pt_BR     ksiq_msg not                                                                                        admin     info                Não
pt_BR     nao                                                                                                 admin     info                Não
pt_BR     o aplicativo (%1) ja esta cadastrado                                                                admin     info                O aplicativo (%1) já está cadastrado
pt_BR     o campo nome do aplicativo e obrigatorio.                                                           admin     info                O campo nome do aplicativo e obrigatório.
pt_BR     o local da rede e obrigatorio                                                                       admin     info                O local da rede e obrigatório
pt_BR     o nome do local e obrigatorio                                                                       admin     info                O nome do local e obrigatório
pt_BR     ok                                                                                                  admin     info                OK
pt_BR     observacao                                                                                          admin     info                Observação
pt_BR     observacao:                                                                                         admin     info                Observação:
pt_BR     observacoes                                                                                         admin     info                Observações
pt_BR     ocorreu erro no processamento...                                                                    admin     info                Ocorreu erro no processamento...
pt_BR     ocorreu um erro durante a atualizacao da tabela %1 ou sua sessao expirou                            admin     info                Ocorreu um erro durante a atualização da tabela %1 ou sua sessão expirou
pt_BR     ocorreu um erro durante a consulta a tabela tipos_software ou sua sessao expirou!                   admin     info                Ocorreu um erro durante a consulta à tabela tipos_software ou sua sessão expirou!
pt_BR     ocorreu um erro durante exclusao de referencia em %1 ou sua sessao expirou!                         admin     info                Ocorreu um erro durante exclusão de referência em %1 ou sua sessão expirou!
pt_BR     ocorreu um erro no acesso a tabela %1 ou sua sessao expirou                                         admin     info                Ocorreu um erro no acesso a tabela %1 ou sua sessão expirou
pt_BR     ocorreu um erro no select ou sua sessao expirou!                                                    admin     info                Ocorreu um erro no select ou sua sessão expirou!
pt_BR     ocorreu um erro no select ou sua sessÃ£o expirou!                                                   admin     info                Ocorreu um erro no select ou sua sessão expirou!
pt_BR     oito                                                                                                admin     info                Oito
pt_BR     ok!                                                                                                 admin     info                Ok!
pt_BR     onde executar essa acao-configuracao                                                                admin     info                Onde executar essa ação-configuração
pt_BR     onze                                                                                                admin     info                Onze
pt_BR     opcoes avancadas                                                                                    admin     info                Opções avançadas
pt_BR     opcoes da coleta de informacoes patrimoniais e localizacao fisica                                   admin     info                Opções da Coleta de Informações Patrimoniais e Localização Física
pt_BR     operacao                                                                                            admin     info                Operação
...
pt_BR     patrimonio                                                                                          admin     info                Patrimônio
pt_BR     patrimonio de destino:                                                                              admin     info                Patrimônio de Destino:
pt_BR     patrimonio e um campo obrigatorio!                                                                  admin     info                Patrimônio e um campo obrigatório!
pt_BR     patrimonio:                                                                                         admin     info                Patrimônio:
...
pt_BR     proprietario                                                                                        admin     info                Proprietário
...
pt_BR     realizar notificacao caso haja alteracoes nas seguintes configuracoes de hardware                   admin     info                Realizar notificação caso haja alterações nas seguintes configurações de hardware
...
pt_BR     resumo das operacoes                                                                                admin     info                Resumo das Operações
pt_BR     resumo das tentativas de instalacao                                                                 admin     info                Resumo das Tentativas de Instalação
pt_BR     resumo quantitativo de licencas                                                                     admin     info                Resumo quantitativo de licenças
...
pt_BR     selecionados:                                                                                       admin     info                Selecionados:
pt_BR     selecionar computadores para exclusao                                                               admin     info                Selecionar computadores para exclusão
pt_BR     selecionar novamente                                                                                admin     info                Selecionar novamente
pt_BR     selecione                                                                                           admin     info                Selecione
pt_BR     selecione a gerencia de localizacao este equipamento                                                admin     info                Selecione a Gerência de localização este equipamento
pt_BR     selecione a linha de negocio de localizacao deste equipamento                                       admin     info                Selecione a Linha de negócio de localização deste equipamento
pt_BR     selecione a divisao onde encontra-se este equipamento                                               admin     info                Selecione a divisão onde encontra-se este equipamento
pt_BR     selecione local                                                                                     admin     info                Selecione local
pt_BR     selecione o periodo em que devera ser realizada a consulta                                          admin     info                Selecione o período em que deverá ser realizada a consulta
pt_BR     selecione o periodo em que devera ser realizada a consulta:                                         admin     info                Selecione o período em que deverá ser realizada a consulta:
pt_BR     selecione o periodo no qual devera ser realizada a consulta                                         admin     info                Selecione o período no qual deverá ser realizada a consulta
...
pt_BR     senha padrao para administrar o agente                                                              admin     info                Senha padrão para administrar o agente
...
pt_BR     servidor de aplicacao padrao                                                                        admin     info                Servidor de Aplicação padrao
pt_BR     servidor de atualizacoes (ftp)                                                                      admin     info                Servidor de Atualizações (FTP)
pt_BR     servidor de updates padrao                                                                          admin     info                Servidor de Atualizações Padrão
pt_BR     servidor de aplicacao (gerente)                                                                     admin     info                Servidor de aplicação (gerente)
pt_BR     servidor nao encontrado                                                                             admin     info                Servidor não encontrado
...
pt_BR     sistemas operacionais onde essa acao-configuracao devera ser aplicada                               admin     info                Sistemas Operacionais onde essa ação-configuração deverá ser aplicada
...
pt_BR     software e um campo obrigatorio!                                                                    admin     info                Software é um campo obrigatório!
...
pt_BR     softwares por aquisicao                                                                             admin     info                Softwares por Aquisição
...
pt_BR     sucesso na conexao ftp                                                                              admin     info                Sucesso na conexão FTP
pt_BR     termine com                                                                                         admin     info                TERMINE COM
pt_BR     tabela                                                                                              admin     info                Tabela
pt_BR     tamanho (kb)                                                                                        admin     info                Tamanho (KB)
pt_BR     tamanho(kb)                                                                                         admin     info                Tamanho(kb)
pt_BR     tela de coleta de informacoes de patrimonio                                                         admin     info                Tela de Coleta de Informações de Patrimônio
...
pt_BR     tipo da licenca                                                                                     admin     info                Tipo da Licença
...
pt_BR     tres                                                                                                admin     info                Três
pt_BR     troca de senha de acesso                                                                            admin     info                Troca de Senha de Acesso
pt_BR     ultima alteracao em                                                                                 admin     info                Ultima Alteração em
...
pt_BR     unidade da federacao                                                                                admin     info                Unidade da Federação
pt_BR     usuario                                                                                             admin     info                Usuário
pt_BR     usuarios associados ao local                                                                        admin     info                Usuários Associados ao Local
pt_BR     usuarios primarios                                                                                  admin     info                Usuários Primários
pt_BR     usuarios secundarios                                                                                admin     info                Usuários Secundários
pt_BR     valor para pesquisa                                                                                 admin     info                Valor para pesquisa
pt_BR     verificacao ativa                                                                                   admin     info                Verificação Ativa
pt_BR     verificacao ativa?                                                                                  admin     info                Verificação Ativa?
pt_BR     verificacao efetuada                                                                                admin     info                Verificação efetuada
pt_BR     verifique os campos destacados em amarelo                                                           admin     info                Verifique os campos destacados em amarelo
pt_BR     versao de executavel                                                                                admin     info                Versão de executável
pt_BR     visualizacao das ocorrencias com as operacoes de atualizacao, inclusao e exclusao no sistema.       admin     info                Visualização das ocorrências com as operações de atualização, inclusão e exclusão no sistema.
pt_BR     voce deve informar a data de aquisicao.                                                             admin     info                Você deve informar a data de aquisição.
pt_BR     voce deve informar o numero do processo no formato                                                  admin     info                Você deve informar o número do processo no formato
...
pt_BR     eh necessario informar ao menos uma condicao para pesquisa                                          admin     info                É necessário informar ao menos uma condição para pesquisa
pt_BR     eh um sistema operacional?                                                                          admin     info                É um Sistema Operacional?
pt_BR     a pesquisa nao retornou registros                                                                   statisticsinfo                A pesquisa não retornou registros
pt_BR     clique sobre o nome da maquina para ver os detalhes da mesma                                        statisticsinfo                Clique sobre o nome da máquina para ver os detalhes da mesma
pt_BR     dica: use shift or ctrl para selecionar multiplos itens                                             statisticsinfo                Dica: use SHIFT or CTRL para selecionar múltiplos itens
pt_BR     disponiveis:                                                                                        statisticsinfo                Disponíveis:
pt_BR     engine                                                                                              statisticsinfo                Engine
pt_BR     estatisticas de antivirus officescan - informe                                                      statisticsinfo                Esta opção exibe estatísticas sobre o Antivírus OfficeScan nos computadores das redes selecionadas. É possível determinar os sistemas operacionais e a abrangência das redes.
pt_BR     estatisticas de sistemas monitorados - informe                                                      statisticsinfo                Esta opção exibe estatísticas sobre os Sistemas monitorados nos computadores das redes selecionadas. É possível determinar quais sistemas serão exibidos, os sistemas operacionais e a abrangência das redes.
pt_BR     estatisticas de antivirus officescan                                                                statisticsinfo                Estatísticas de Antivírus OfficeScan
pt_BR     estatisticas de sistemas monitorados                                                                statisticsinfo                Estatísticas de sistemas monitorados
pt_BR     gerar relatorio                                                                                     statisticsinfo                Gerar relatório
pt_BR     ip                                                                                                  statisticsinfo                IP
pt_BR     licenca                                                                                             statisticsinfo                Licença
pt_BR     pattern                                                                                             statisticsinfo                Pattern
pt_BR     relacao de maquinas com o engine                                                                    statisticsinfo                Relação de máquinas com o engine
pt_BR     relacao de maquinas com o pattern                                                                   statisticsinfo                Relação de máquinas com o pattern
...
pt_BR     total de maquinas                                                                                   statisticsinfo                Total de máquinas
pt_BR     versao                                                                                              statisticsinfo                Versão
pt_BR     ultima coleta                                                                                       statisticsinfo                Última coleta
...
pt_BR     (obs: estao sendo exibidas somente as redes selecionadas pelo administrador.)                       geral     info                (OBS: Estão sendo exibidas somente as redes selecionadas pelo administrador.)
...
pt_BR     statistics                                                                                          geral     TagHeader           Estatísticas
...
pt_BR     ha 1 dia............                                                                                geral     info                Há 1 dia............
pt_BR     ha 2 dias...........                                                                                geral     info                Há 2 dias...........
pt_BR     ha 3 dias...........                                                                                geral     info                Há 3 dias...........
pt_BR     ha 4 dias...........                                                                                geral     info                Há 4 dias...........
pt_BR     ha mais de 365 dias.                                                                                geral     info                Há mais de 365 dias.
...
pt_BR     kciq_msg org label help                                                                             geral     ajuda               Nome da empresa onde está instalado o gerente
...
pt_BR     verificacao/atualizacao dos servidores de updates                                                   geral     info                Verificação/Atualização dos Servidores de Updates
pt_BR     kciq_msg version                                                                                    geral     info                Versão
pt_BR     versao do agente principal                                                                          geral     info                Versão do agente principal
pt_BR     kciq_msg login needed                                                                               geral     info                É necessário efetuar autenticação
pt_BR     ultimo acesso                                                                                       geral     info                Último acesso
...
pt_BR     kciq_msg inst insert basic data                                                                     instaladorinfo                Inclusão de dados básicos nas tabelas do banco de dados (%1)
pt_BR     kciq_msg inst insert demo data                                                                      instaladorinfo                Inclusão de dados para demonstração
...
pt_BR     kciq_msg inst database sqldemodata not defined                                                      instaladorerro                Não há dados (%1) disponíveis para demonstração!
pt_BR     kciq_msg inst insert demo data error                                                                instaladorerro                Não há dados disponíveis para demonstração!
pt_BR     kciq_msg inst database sqldata not defined                                                          instaladorerro                Não há instruções SQL (%1 ou %2) referentes aos dados base para o CACIC!
pt_BR     kciq_msg inst database sqlupdatedata not defined                                                    instaladorerro                Não há instruções SQL (%1) para atualização do banco de dados do CACIC!
pt_BR     kciq_msg inst database sqlbuild not defined                                                         instaladorerro                Não há instruções SQL (%1) para criação das tabelas do banco de dados!
pt_BR     kciq_msg inst database standard sqldata should be used                                              instaladorerro                Não há instruções SQL (%1) referentes aos dados base para o CACIC! Dados padrão (%2) serão usados!
pt_BR     kciq_msg inst tables update error                                                                   instaladorerro                Não há instruções SQL para atualização das tabelas do banco de dados!
pt_BR     kciq_msg inst tables build error                                                                    instaladorerro                Não há instruções SQL para criação das tabelas do banco de dados!
...
pt_BR     kciq_msg phpldap_help                                                                               instaladorinfo                Para executar o CACIC é necessário instalar a biblioteca de para uso de LDAP.
...
pt_BR     kciq_mnt_tradutor                                                                                   manutencaoinfo                Tradução de texto do CACIC
...
pt_BR     antivirus ativo                                                                                     relatoriosinfo                Antivírus ativo
pt_BR     antivirus officescan                                                                                relatoriosinfo                Antivírus officeScan
pt_BR     ativo                                                                                               relatoriosinfo                Ativo
pt_BR     bios                                                                                                relatoriosinfo                BIOS
pt_BR     cpu                                                                                                 relatoriosinfo                CPU
pt_BR     campos obrigatorios                                                                                 relatoriosinfo                Campos obrigatórios
pt_BR     clique sobre o nome da maquina para ver os detalhes                                                 relatoriosinfo                Clique sobre o nome da máquina para ver os detalhes
pt_BR     comentario                                                                                          relatoriosinfo                Comentário
pt_BR     compartilhamento de diretorio                                                                       relatoriosinfo                Compartilhamento de diretório
pt_BR     compartilhamento de impressora                                                                      relatoriosinfo                Compartilhamento de impressora
pt_BR     compartilhamentos de diretorios e impressoras                                                       relatoriosinfo                Compartilhamentos de diretórios e impressoras
pt_BR     computador inexistente                                                                              relatoriosinfo                Computador inexistente
pt_BR     dados da modificacao                                                                                relatoriosinfo                Dados da modificação
pt_BR     dados historicos                                                                                    relatoriosinfo                Dados históricos
pt_BR     dados historicos obtidos de versoes anteriores a 2.4                                                relatoriosinfo                Dados históricos obtidos de versões anteriores a 2.4
pt_BR     data da alteracao                                                                                   relatoriosinfo                Data da alteração
pt_BR     data da ultima coleta                                                                               relatoriosinfo                Data da última coleta
pt_BR     data de alteracao                                                                                   relatoriosinfo                Data de alteração
pt_BR     data de instalacao                                                                                  relatoriosinfo                Data de instalação
pt_BR     data/hora da ultima coleta                                                                          relatoriosinfo                Data/Hora da última coleta
pt_BR     data/hora do ultimo acesso                                                                          relatoriosinfo                Data/Hora do último acesso
pt_BR     data/hora inclusao                                                                                  relatoriosinfo                Data/Hora inclusão
pt_BR     data/hora instalacao                                                                                relatoriosinfo                Data/Hora instalação
...
pt_BR     diretorio                                                                                           relatoriosinfo                Diretório
pt_BR     dominio dns                                                                                         relatoriosinfo                Domínio DNS
pt_BR     endereco tcp/ip                                                                                     relatoriosinfo                Endereço TCP/IP
pt_BR     endereco de rede                                                                                    relatoriosinfo                Endereço de rede
pt_BR     endereco do servidor                                                                                relatoriosinfo                Endereço do servidor
pt_BR     espaco (mb)                                                                                         relatoriosinfo                Espaço (MB)
pt_BR     estado do officescan                                                                                relatoriosinfo                Estado do OfficeScan
pt_BR     exibe as alteracoes nas configuracoes de hardware dos computadores.                                 relatoriosinfo                Exibe as alterações nas configurações de hardware dos computadores.
pt_BR     exibir informacoes de patrimonio                                                                    relatoriosinfo                Exibir informações de patrimônio
pt_BR     fabricante                                                                                          relatoriosinfo                Fabricante
pt_BR     ferramentas                                                                                         relatoriosinfo                Ferramentas
pt_BR     forcar coletas                                                                                      relatoriosinfo                Forçar coletas
...
pt_BR     gravacao                                                                                            relatoriosinfo                Gravação
pt_BR     hardware instalado                                                                                  relatoriosinfo                Hardware instalado
pt_BR     historico de alteracoes das informacoes de patrimonio                                               relatoriosinfo                Histórico de alterações das informações de patrimônio
pt_BR     historico de alteracoes na configuracao de hardware                                                 relatoriosinfo                Histórico de alterações na configuração de hardware
pt_BR     historico de alteracoes na configuracao de rede                                                     relatoriosinfo                Histórico de alterações na configuração de rede
pt_BR     identificador/versao                                                                                relatoriosinfo                Identificador/versão
pt_BR     informacoes basicas                                                                                 relatoriosinfo                Informações básicas
pt_BR     informacoes de patrimonio e localizacao fisica                                                      relatoriosinfo                Informações de patrimônio e localização física
...
pt_BR     memoria ram                                                                                         relatoriosinfo                Memória RAM
pt_BR     modem                                                                                               relatoriosinfo                Modem
pt_BR     mostrar somente dados historicos?                                                                   relatoriosinfo                Mostrar somente dados históricos?
pt_BR     mostrar tambem dados historicos?                                                                    relatoriosinfo                Mostrar também dados históricos?
pt_BR     mouse                                                                                               relatoriosinfo                Mouse
pt_BR     mascara de rede                                                                                     relatoriosinfo                Máscara de rede
pt_BR     modulo de coleta de compartilhamentos de diretorios e impressoras nao habilitado pelo administrador relatoriosinfo                Módulo de coleta de compartilhamentos de diretórios e impressoras não habilitado pelo Administrador
pt_BR     nao existem compartilhamentos nesta maquina                                                         relatoriosinfo                Não existem compartilhamentos nesta máquina
pt_BR     nao existem unidades de disco nesta maquina                                                         relatoriosinfo                Não existem unidades de disco nesta máquina
pt_BR     nao foram coletadas informacoes de aplicativos monitorados referente a esta maquina                 relatoriosinfo                Não foram coletadas informações de aplicativos monitorados referente a esta máquina
pt_BR     nao foram coletadas informacoes de patrimonio e/ou localizacao fisica                               relatoriosinfo                Não foram coletadas informações de patrimônio e/ou Localização física
pt_BR     nao foram coletadas informacoes de software inventariado referente a esta maquina                   relatoriosinfo                Não foram coletadas informações de software inventariado referente a esta máquina
pt_BR     nao foram coletadas informacoes de software referente a esta maquina                                relatoriosinfo                Não foram coletadas informações de software referente a esta máquina
pt_BR     nao foram coletadas informacoes de variaveis de ambiente referente a esta maquina                   relatoriosinfo                Não foram coletadas informações de variáveis de ambiente referente a esta máquina
pt_BR     nao foram coletadas informacoes do officescan referente a esta maquina                              relatoriosinfo                Não foram coletadas informações do OfficeScan referente a esta máquina
pt_BR     nao foram encontradas alteracoes de hardware!                                                       relatoriosinfo                Não foram encontradas alterações de hardware!
pt_BR     numero serial                                                                                       relatoriosinfo                Número serial
pt_BR     o modulo de coleta de informacoes de hardware nao foi habilitado pelo administrador                 relatoriosinfo                O modulo de coleta de informações de hardware não foi habilitado pelo Administrador
pt_BR     o modulo de coleta de informacoes das unidades de disco nao foi habilitado pelo administrador       relatoriosinfo                O módulo de coleta de informacoes das Unidades de Disco nao foi habilitado pelo Administrador
pt_BR     o modulo de coleta de informacoes de patrimonio nao foi habilitado pelo administrador               relatoriosinfo                O módulo de coleta de informações de patrimônio não foi habilitado pelo Administrador
pt_BR     o modulo de coleta de informacoes de sistemas monitorados nao foi habilitado pelo administrador     relatoriosinfo                O módulo de coleta de informações de sistemas monitorados não foi habilitado pelo administrador
pt_BR     o modulo de coleta de informacoes de software nao foi habilitado pelo administrador                 relatoriosinfo                O módulo de coleta de informações de software não foi habilitado pelo Administrador
pt_BR     o modulo de coleta de informacoes do antivirus officescan nao foi habilitado pelo administrador     relatoriosinfo                O módulo de coleta de informações do Antivírus OfficeScan não foi habilitado pelo Administrador
pt_BR     opcoes administrativas                                                                              relatoriosinfo                Opções administrativas
pt_BR     permissao                                                                                           relatoriosinfo                Permissão
pt_BR     periodo                                                                                             relatoriosinfo                Período
pt_BR     periodo da data de instalacao do antivirus para pesquisa                                            relatoriosinfo                Período da data de instalação do antivírus para pesquisa
pt_BR     pesquisar                                                                                           relatoriosinfo                Pesquisar
pt_BR     placa de som                                                                                        relatoriosinfo                Placa de som
pt_BR     placa de video                                                                                      relatoriosinfo                Placa de vídeo
pt_BR     placa mae                                                                                           relatoriosinfo                Placa mãe
pt_BR     protocolo tcp/ip (configuracao principal)                                                           relatoriosinfo                Protocolo TCP/IP (Configuração Principal)
pt_BR     quantidade de cores                                                                                 relatoriosinfo                Quantidade de cores
pt_BR     quantidade de memoria                                                                               relatoriosinfo                Quantidade de memória
pt_BR     registros                                                                                           relatoriosinfo                Registros
pt_BR     registros nao encontrados na tabela %1 ou sua sessao expirou!                                       relatoriosinfo                Registros não encontrados na tabela %1 ou sua sessão expirou!
pt_BR     registros nao encontrados na tabela %1 para os dados fornecidos!                                    relatoriosinfo                Registros não encontrados na tabela %1 para os dados fornecidos!
pt_BR     relatorio de alteracao de hardware                                                                  relatoriosinfo                Relatório de alteração de hardware
pt_BR     relatorio de alteracoes de hardware                                                                 relatoriosinfo                Relatório de alterações de hardware
pt_BR     relatorio de alteracoes de software                                                                 relatoriosinfo                Relatório de alterações de software
pt_BR     relatorio de alteracoes de softwares instalados nos computadores da rede selecionada                relatoriosinfo                Relatório de alterações de softwares instalados nos computadores da rede selecionada
pt_BR     relatorio de configuracoes de hardware                                                              relatoriosinfo                Relatório de configurações de hardware
pt_BR     relatorio de configuracoes do antivirus officescan                                                  relatoriosinfo                Relatório de configurações do antivírus OfficeScan
pt_BR     relatorio de informacoes de patrimonio e localizacao fisica                                         relatoriosinfo                Relatório de informações de patrimônio e localização física
pt_BR     relatorio de maquinas com inventario desatualizado                                                  relatoriosinfo                Relatório de máquinas com inventário desatualizado
pt_BR     relatorio de maquinas com inventario em branco                                                      relatoriosinfo                Relatório de máquinas com inventário em branco
pt_BR     relatorio de maquinas com nome repetido                                                             relatoriosinfo                Relatório de máquinas com nome repetido
pt_BR     relatorio de pastas compartilhadas                                                                  relatoriosinfo                Relatório de pastas compartilhadas
pt_BR     relatorio que exibe os compartilhamentos nos microcomputadores das redes selecionadas               relatoriosinfo                Relatório que exibe os compartilhamentos nos microcomputadores das redes selecionadas
pt_BR     remover computador                                                                                  relatoriosinfo                Remover computador
pt_BR     removido                                                                                            relatoriosinfo                Removido
pt_BR     resolucao                                                                                           relatoriosinfo                Resolução
pt_BR     risco alto: integridade e privacidade                                                               relatoriosinfo                Risco alto: integridade e privacidade
pt_BR     risco medio: privacidade                                                                            relatoriosinfo                Risco médio: privacidade
pt_BR     rotulo                                                                                              relatoriosinfo                Rótulo
pt_BR     selecione as configuracoes de hardware que deseja exibir                                            relatoriosinfo                Selecione as configurações de hardware que deseja exibir
pt_BR     selecione as configuracoes que deseja exibir                                                        relatoriosinfo                Selecione as configurações que deseja exibir
pt_BR     selecione as redes                                                                                  relatoriosinfo                Selecione as redes
pt_BR     selecione os servidores de atualizacao para consulta                                                relatoriosinfo                Selecione os servidores de atualização para consulta
pt_BR     selecione os tipos de hardware a serem exibidos no relatorio.                                       relatoriosinfo                Selecione os tipos de hardware a serem exibidos no relatório.
pt_BR     servidor dhcp                                                                                       relatoriosinfo                Servidor DHCP
pt_BR     servidor dns primario                                                                               relatoriosinfo                Servidor DNS primário
pt_BR     servidor dns secundario                                                                             relatoriosinfo                Servidor DNS secundário
pt_BR     servidor wins primario                                                                              relatoriosinfo                Servidor WINS primário
pt_BR     servidor wins secundario                                                                            relatoriosinfo                Servidor WINS secundário
pt_BR     servidor do officescan                                                                              relatoriosinfo                Servidor do OfficeScan
pt_BR     servicos abertos para a rede                                                                        relatoriosinfo                Serviços abertos para a rede
...
pt_BR     sao necessarios parametros para gerar o relatorios!                                                 relatoriosinfo                São necessários parâmetros para gerar o relatórios!
...
pt_BR     tipo de alteracao                                                                                   relatoriosinfo                Tipo de alteração
...
pt_BR     utilizacao (%)                                                                                      relatoriosinfo                Utilização (%)
pt_BR     variaveis de ambiente                                                                               relatoriosinfo                Variáveis de ambiente
pt_BR     versao do dao                                                                                       relatoriosinfo                Versao do DAO
pt_BR     versao da maquina virtual java (jvm)                                                                relatoriosinfo                Versão da maquina virtual java (JVM)
pt_BR     versao do ado                                                                                       relatoriosinfo                Versão do ADO
pt_BR     versao do acrobat reader                                                                            relatoriosinfo                Versão do Acrobat Reader
pt_BR     versao do bde                                                                                       relatoriosinfo                Versão do BDE
pt_BR     versao do directx                                                                                   relatoriosinfo                Versão do DirectX
pt_BR     versao do mozilla                                                                                   relatoriosinfo                Versão do Mozilla
pt_BR     versao do odbc                                                                                      relatoriosinfo                Versão do ODBC
pt_BR     versao agente principal                                                                             relatoriosinfo                Versão do agente principal
pt_BR     versao do engine                                                                                    relatoriosinfo                Versão do engine
pt_BR     versao gerente de coletas                                                                           relatoriosinfo                Versão do gerente de coletas
pt_BR     versao do gerente de coletas                                                                        relatoriosinfo                Versão do gerente de coletas
pt_BR     versao do internet explorer                                                                         relatoriosinfo                Versão do internet explorer
