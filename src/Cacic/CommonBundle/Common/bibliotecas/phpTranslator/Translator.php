...
Class Translator {
    ...
    */ 
     ...
     * @since v 0.2.1
	 * @access public
	 * @return array Matriz de dados de cada idioma no qual a aplica��o foi traduzida.
	 *
	 *       Formato da matriz:   
	 *          $language_set = array( 'pt_BR' => ('descr' => 'Portugu�s Brasileiro',
	 *                                         'charset' => 'iso-8859-1',
	...
	/**
	 * Diret�rio dos idiomas no qual a aplica��o foi traduzida
	 * 
     * @since v 0.2.1
	 * @access public
	 * @return string Diretorio dos idiomas no qual a aplica��o foi traduzida.
	 * 
	 */
