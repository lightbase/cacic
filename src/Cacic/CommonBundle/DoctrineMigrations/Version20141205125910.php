...
class Version20141205125910 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql(" ALTER TABLE aquisicao_item DROP CONSTRAINT aquisicao_item_pkey CASCADE");
        ...
        $sql = "SELECT TRUE
            FROM   pg_attribute
            WHERE  attrelid = 'aquisicao_item'::regclass  -- cast to a registered class (table)
            AND    attname = 'id_software'
