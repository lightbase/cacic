 ...
 */
class Version20150413120923 extends AbstractMigration implements ContainerAwareInterface
{
    private $container;
    ...
    public function up(Schema $schema)
    {
        ...
        $upgrade1 = $rootDir."/../src/Cacic/CommonBundle/Resources/data/upgrade-3.1.12-2.sql";
        ...
        $this->addSql("SELECT upgrade_software2()");
