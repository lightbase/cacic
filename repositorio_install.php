...
<br><br>
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    <tr> 
      <td class="label"> 
        &nbsp; &nbsp;<br>
        <a href="repositorio/install/chkcacic.exe">ChkCACIC -  Verificador/Instalador/Atualizador do Sistema CACIC  <span class="style2"><span class="style6">(versão <? echo $v_array_versoes_agentes['chkcacic.exe'];?>  ~  260K)</span></span></a><a href="repositorio/install/chkcacic.ini" class="descricao"> (configurado para  UXRJO115)</a></td>
    </tr>
