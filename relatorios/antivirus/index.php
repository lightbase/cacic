                ...
                <tr> 
                  ...
                  <td> <div align="left"> 
                      <select multiple name="list5[]" size="10" class="normal" onFocus="SetaClassDigitacao(this);" onBlur="SetaClassNormal(this);" >
                        ...
                        do Pattern</option>
                        <option value=", DATE_FORMAT(dt_hr_instalacao,'%d/%m/%Y � %H:%ih') as &quot;Data/Hora Instala&ccedil;&atilde;o&quot;">Data/Hora 
                        Instala&ccedil;&atilde;o</option>
                        <option value=", DATE_FORMAT(dt_hr_coleta,'%d/%m/%Y � %H:%ih') as &quot;Data/Hora &Uacute;ltima Coleta&quot;">Data/Hora 
