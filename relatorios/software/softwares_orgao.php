...
if (($_SESSION['ftr_consulta'] == 'todos') or ($_SESSION['ftr_consulta'] == '')) {
	$valor_padrao_software_orgao = '<option value="todos">Mostrar todos</option>
			...
			<option value="licenciados">Mostrar somente softwares licenciados</option>
...
if (($_SESSION['ftr_consulta'] == 'licenciados')) {
	$valor_padrao_software_orgao = '<option value="licenciados">Mostrar somente softwares licenciados</option>
			<option value="todos">Mostrar todos</option>
			<option value="nao_correcao">Não mostrar atualizações/correções</option>
			<option value="suspeitos">Mostrar somente softwares suspeitos</option>';
}
...
<tr> 
      <td class="cabecalho">Relat&oacute;rio de softwares por &oacute;rg&atilde;o 
        (ou m&aacute;quina)</td>
</tr>
<tr> 
<td>&nbsp;</td>
</tr>
...
<td>&Oacute;rg&atilde;o (ou m&aacute;quina): 
              </td>
            <td> 
...
if ($_POST['consultar']) {
	...
	if ($_SESSION['ftr_consulta'] == 'todos') {
		...
		(c.te_nome_computador like '%". $_SESSION['str_orgao'] ."%') 
