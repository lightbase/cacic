...
<table border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#999999">
  ...
  <tr bgcolor="#E1E1E1"> 
    <td nowrap bgcolor="#FFFFFF"><font color="#333333" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>CACIC - Relat&oacute;rio de M&aacute;quinas Windows Server Standard</strong></font></td>
  </tr>
  <tr> 
  ...
  <tr><td></td></tr>
  <tr>
    <td colspan=3><p align="center"><font size="2" color="red" face="Verdana, Arial, Helvetica, sans-serif"><b>Instalados na CORED:</b> Standard (7), Web (2), Enterprise (56)</font></p></td>
  </tr>
  <tr>
    <td colspan=3><p align="center"><font size="2" color="green" face="Verdana, Arial, Helvetica, sans-serif"><b>Contrato Select:</b> Standard (5), Web (6), Enterprise (30)</font></p></td>
  </tr>
...
<?
	 $query = "SELECT a.te_nome_computador as nm_maquina, 
			  a.te_node_address, a.id_so, a.dt_hr_ult_acesso  
		FROM computadores a, aplicativos_monitorados b 
		WHERE (b.id_aplicativo = 56) AND (b.cs_instalado = 'S') AND
		      (a.te_node_address = b.te_node_address) AND 
		      (a.id_so = b.id_so) 
...
?>
  ...
  <tr> 
    <td height="10"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Nao consta desta relacao os servidores da CORED</font></td>
  </tr>
</table>
