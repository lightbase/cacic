...
<table border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#999999">
  ...
  <tr bgcolor="#E1E1E1"> 
    <td nowrap bgcolor="#FFFFFF"><font color="#333333" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>CACIC 
      - Relat&oacute;rio de M&aacute;quinas sem agente TNG</strong></font></td>
  </tr>
  <tr> 
...
?>
<?
	 $query = "SELECT a.te_nome_computador as nm_maquina, a.te_node_address, a.id_so, a.te_ip, a.dt_hr_ult_acesso 
		FROM computadores a 
		WHERE (a.te_node_address NOT IN 
 			(SELECT te_node_address
			 FROM softwares_inventariados_estacoes 
			 WHERE (id_software_inventariado = 2) OR (id_software_inventariado = 87)))  
