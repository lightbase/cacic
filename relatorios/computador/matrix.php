	...
	while($row = mysql_fetch_array($result)) {
	 ...
	 ?>
        <tr <? if ($Cor) { echo 'bgcolor="#E1E1E1"'; } ?>> 
          ...
          <td nowrap>&nbsp;&nbsp;</td>
	  <td align="center" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $row['te_cpu_desc']; ?></font></td>
          <td nowrap>&nbsp;&nbsp;</td>
	  <td align="center" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $row['te_placa_mae_desc']; ?></font></td>
          <td nowrap>&nbsp;&nbsp;</td>
	  <td align="center" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $row['qt_mem_ram']; ?></font></td>
          <td nowrap>&nbsp;&nbsp;</td>
	  <td align="center" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $row['te_cpu_freq']; ?></font></td>
	  <td nowrap>&nbsp;&nbsp;</td>
          <? 
	$Cor=!$Cor;
	$NumRegistro++;
