...
<table border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#999999">
  ...
  <tr bgcolor="#E1E1E1"> 
    <td nowrap bgcolor="#FFFFFF"><font color="#333333" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>CACIC - Relat&oacute;rio de M&aacute;quinas Standard com Access</strong></font></td>
  </tr>
  <tr> 
...
<?
	 $query = "SELECT c.te_nome_computador as nm_maquina, 
			  c.te_node_address, c.id_so, c.te_ip, 
			  c.dt_hr_ult_acesso  
		FROM computadores c, aplicativos_monitorados am, 
		     softwares_inventariados_estacoes sie 
		WHERE (sie.id_software_inventariado = 971) AND 
		      (am.te_node_address = sie.te_node_address) AND
		      (am.id_so = sie.id_so) AND (am.id_aplicativo = 59) AND
		      (am.te_versao < '?') AND 
		      (c.te_node_address = sie.te_node_address) AND 
		      (c.id_so = sie.id_so) 
