...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
        ...
        <tr valign="baseline"> 
          <td><img src="imgs/arrow.gif" width="16" height="16"></td>
          <td><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><font color="#666666"><font color="#333333"><a href="downloads/" target="_blank">Downloads</a></font></font></font></td>
        </tr>
        <tr valign="baseline"> 
          <td><img src="imgs/arrow.gif" width="16" height="16"></td>
