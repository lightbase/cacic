<?php 
/* 
        Versуo modificada do arquivo install.inc.php do DotProject 
        Modificaчуo por Thomaz de Oliveira dos Reis (thor27 EM gmail PONTO com). 
*/ 
function dPmsg($msg) 
{ 
 echo $msg . "\n"; 
...
{ 
 ...
 if (! file_exists($sqlfile)) { 
        dPmsg("Nуo foi encontrado arquivo SQL"); 
        return false; 
} 
 ...
 if ($errors > 0) { 
         dPmsg("AVISO: $errors dos $piece_count comandos SQL, nуo foram executados."); 
        return false; 
 } 
 return true; 
} 
