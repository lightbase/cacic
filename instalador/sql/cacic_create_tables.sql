...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin COMMENT='Tabela para auxílio na opção Exclusão de Informações de computador';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Localizações para regionalização de acesso a dados' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Servidores para Autenticação do srCACIC' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Registros de Conexões efetuadas em sessões abertas' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `te_locais_secundarios` text default NULL,
