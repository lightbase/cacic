...
CREATE  TABLE IF NOT EXISTS `configuracoes_padrao` (
  ...
  `id_default_body_bgcolor` VARCHAR(10) NOT NULL DEFAULT '#EBEBEB' ,
  `te_standard_language` VARCHAR(5) NOT NULL DEFAULT 'pt_BR' ,
  `te_exibe_graficos` VARCHAR(100) NOT NULL DEFAULT '[acessos_locais][so][acessos][locais]' ,
  `nu_porta_srcacic` VARCHAR(5) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL DEFAULT '5900' ,
...
CREATE  TABLE IF NOT EXISTS `perfis_aplicativos_monitorados` (
  ...
  `te_arq_ver_eng_w9x` VARCHAR(255) NULL DEFAULT NULL ,
  `te_arq_ver_pat_w9x` VARCHAR(255) NULL DEFAULT NULL ,
  `te_arq_ver_eng_wnt` VARCHAR(255) NULL DEFAULT NULL ,
  `te_arq_ver_pat_wnt` VARCHAR(255) NULL DEFAULT NULL ,
  `te_dir_padrao_w9x` VARCHAR(255) NULL DEFAULT NULL ,
  `te_dir_padrao_wnt` VARCHAR(255) NULL DEFAULT NULL ,
