...
if (!$_SESSION["id_usuario"])
	...
	if ($_SESSION['id_grupo_usuarios']<>3) // Caso nao seja usuario "Convidado" (atribuido automaticamente quando rede e local sao identificados)		
		...
		?>
	<tr>
		<td> <a href="/cacic/repositorio/install-cacic-mpog.msi"><p>Instalador Windows .MSI</p></a></td>
	</tr>
	<tr>
		<td> <a href="/cacic/repositorio/install/pyCACIC_2.6.0.2_Debian.deb"><p>Instalador Linux .DEB</p></td>
	</tr>
	<tr>
		<td> <a href="/cacic/repositorio/install/chkcacic.exe"><p>Instalador CACIC COMUM</p></a></td>
	</tr>
	<tr>
		<td> <a href="/cacic/repositorio/install/mapacacic.exe"><p>MAPA CACIC</p></a></td>
	</tr>
	</table>
  	</form> 
	<?
