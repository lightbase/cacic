...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder ".", "/home/#{vpdj_config['user']}/projects/#{vpdj_config['domain_name']}"
  # Path to the included files for Puppet.
  config.vm.synced_folder "manifests/files", vpdj_config["inc_file_path"]
  ...
  config.vm.provision "puppet" do |puppet|
    ...
    puppet.facter = {
      "inc_file_path" => vpdj_config["inc_file_path"],
      "tz"            => vpdj_config["tz"],
      "user"          => vpdj_config["user"],
      "password"      => vpdj_config["password"],
      "project"       => vpdj_config["project"],
