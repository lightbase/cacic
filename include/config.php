...
$usuario_bd 	  	= "UserName";  // Usuário usado para acesso ao bd do cacic. 
$senha_usuario_bd   = "Password";
$path_aplicacao		= "/var/www/cacic2"; // Valor utilizado principalmente pela função de Update de SubRedes...
